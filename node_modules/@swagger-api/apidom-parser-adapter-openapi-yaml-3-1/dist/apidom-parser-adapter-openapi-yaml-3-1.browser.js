(function(global, factory) {
	typeof exports === "object" && typeof module !== "undefined" ? factory(exports) : typeof define === "function" && define.amd ? define(["exports"], factory) : (global = typeof globalThis !== "undefined" ? globalThis : global || self, factory(global.apidomParserAdapterOpenapiYaml31 = {}));
	...
	*/
	...
	var GenericMapping = class extends Tag$2 {
	...
	var GenericSequence = class extends Tag$2 {
	...
	var GenericString = class extends Tag$2 {
	...
	*/
	...
	var Boolean$1 = class extends Tag$2 {
	...
	var FloatingPoint = class extends Tag$2 {
	...
	var Integer = class extends Tag$2 {
	...
	*/
	...
	var isNode$2 = pipe(getNodeType$4, isString);
	/**
	* @public
	*/
	var keyMapDefault$1 = {
 ...
 /** @suppress {checkTypes} */ entry.value = addFunction(value, value.sig);
	...
	var createAnalyze = (treeSitterYaml) => async (source) => {
		...
		if (parser$4 === null) throw new ApiDOMError("Error while initializing web-tree-sitter and loading tree-sitter-yaml grammar.");
	...
	*/
	...
	//#endregion
	//#region ../apidom-ns-openapi-3-1/src/media-types.mjs
	/**
	* @public
	*/
	/**
	...
	* @public
	*/
	var yamlMediaTypes = new OpenAPIMediaTypes(...mediaTypes.filterByFormat("generic"), ...mediaTypes.filterByFormat("yaml"));
	//#endregion
	//#region src/adapter.ts
	/**
	* @public
	*/
	var detectionRegExp = /(?<YAML>^(["']?)openapi\2\s*:\s*(["']?)(?<version_yaml>3\.1\.(?:[1-9]\d*|0))\3(?:\s+|$))|(?<JSON>"openapi"\s*:\s*"(?<version_json>3\.1\.(?:[1-9]\d*|0))")/m;
	/**
	* @public
	*/
	...
	* @public
	*/
	var namespace = createNamespace(openApi3_1);
	//#endregion
