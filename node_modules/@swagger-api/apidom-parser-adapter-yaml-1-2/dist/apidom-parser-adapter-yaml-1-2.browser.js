(function(global, factory) {
	typeof exports === "object" && typeof module !== "undefined" ? factory(exports) : typeof define === "function" && define.amd ? define(["exports"], factory) : (global = typeof globalThis !== "undefined" ? globalThis : global || self, factory(global.apidomParserAdapterYaml12 = {}));
	...
	*/
	...
	//#endregion
	//#region wasm/tree-sitter-yaml.wasm
 ...
 /** @suppress {checkTypes} */ entry.value = addFunction(value, value.sig);
	...
	*/
	...
	//#endregion
	//#region src/lexical-analysis/analyze.ts
	...
	* @public
	*/
	var analyze = createAnalyze(tree_sitter_yaml_default);
	//#endregion
	...
	* @public
	*/
	var isNode$3 = (node) => typeof getNodeType$2(node) === "string";
	/**
	* @public
	*/
	...
	*  @public
	*/
	var visit$1 = (root, visitor, { keyMap = null, state = {}, breakSymbol = BREAK, deleteNodeSymbol = null, skipVisitingNodeSymbol = false, visitFnGetter = getVisitFn, nodeTypeGetter = getNodeType$2, nodePredicate = isNode$3, nodeCloneFn = cloneNode$1, detectCycles = true, detectCyclesCallback = null } = {}) => {
	...
	*/
	visit$1[Symbol.for("nodejs.util.promisify.custom")] = async (root, visitor, { keyMap = null, state = {}, breakSymbol = BREAK, deleteNodeSymbol = null, skipVisitingNodeSymbol = false, visitFnGetter = getVisitFn, nodeTypeGetter = getNodeType$2, nodePredicate = isNode$3, nodeCloneFn = cloneNode$1, detectCycles = true, detectCyclesCallback = null } = {}) => {
		const visitorKeys = keyMap || {};
		let stack;
		let inArray = Array.isArray(root);
		let keys = [root];
	...
	*/
	...
	var isNode$2 = pipe(getNodeType$1, isString);
	/**
	* @public
	*/
	var keyMapDefault = {
	...
	*/
	var forEachNamedChild = (cursor, ctx, fn) => {
		...
		do
			...
			} else fn(cursor, cursor.currentFieldName ?? null);
	...
	* @public
	*/
	var analyze$3 = (cst, { sourceMap = false } = {}) => {
	...
	var CstVisitor = class CstVisitor {
		...
		static kindNodeToYamlTag(node) {
			...
			return new YamlTag(assignSourceMap({
				explicitName: tagNode?.text || (node.type === "plain_scalar" ? "?" : "!"),
	...
	//#endregion
	//#region src/syntactic-analysis/indirect/visitors/YamlAstVisitor.ts
	var keyMap = {
		stream: ["children"],
		document: ["children"],
		mapping: ["children"],
	...
	var getNodeType = (node) => {
		if (isElement(node)) return getNodeType$1(node);
	...
	*/
	...
	//#endregion
	//#region src/syntactic-analysis/index.ts
	/**
	...
	* @public
	*/
	var analyze$1 = (cst, options = {}) => {
		try {
			return analyze$3(cst, options);
		} catch (e) {
			if (e instanceof FallbackNeeded) return analyze$2(cst, options);
			throw e;
		}
	};
	//#endregion
	...
	* @public
	*/
	var YamlMediaTypes = class extends MediaTypes {
		latest() {
			return this[1];
		}
	};
	...
	* @public
	*/
	var mediaTypes = new YamlMediaTypes("text/yaml", "application/yaml");
	//#endregion
	...
	* @public
	*/
	var parse = async (source, { sourceMap = false } = {}) => {
		let cst = null;
		try {
			cst = await analyze(source);
