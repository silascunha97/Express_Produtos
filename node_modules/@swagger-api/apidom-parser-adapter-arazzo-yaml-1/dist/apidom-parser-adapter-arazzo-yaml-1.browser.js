(function(global, factory) {
	typeof exports === "object" && typeof module !== "undefined" ? factory(exports) : typeof define === "function" && define.amd ? define(["exports"], factory) : (global = typeof globalThis !== "undefined" ? globalThis : global || self, factory(global.apidomParserAdapterArazzoYaml1 = {}));
 ...
 /** @suppress {checkTypes} */ entry.value = addFunction(value, value.sig);
	...
	* @public
	*/
	var yamlMediaTypes = new ArazzoMediaTypes(...mediaTypes.filterByFormat("generic"), ...mediaTypes.filterByFormat("yaml"));
	//#endregion
	//#region src/adapter.ts
	/**
	* @public
	*/
	var detectionRegExp = /(?<YAML>^(["']?)arazzo\2\s*:\s*(["']?)(?<version_yaml>1\.(?:[1-9]\d*|0)\.(?:[1-9]\d*|0))\3(?:\s+|$))|(?<JSON>"arazzo"\s*:\s*"(?<version_json>1\.(?:[1-9]\d*|0)\.(?:[1-9]\d*|0))")/m;
	/**
	* @public
	*/
