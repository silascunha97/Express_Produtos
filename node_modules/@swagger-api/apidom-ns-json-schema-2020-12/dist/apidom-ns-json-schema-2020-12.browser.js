(function(global, factory) {
	typeof exports === "object" && typeof module !== "undefined" ? factory(exports) : typeof define === "function" && define.amd ? define(["exports"], factory) : (global = typeof globalThis !== "undefined" ? globalThis : global || self, factory(global.apidomNsJsonSchema202012 = {}));
	...
	*/
	...
	var refract$6 = (value, { Type, plugins = [] }) => {
		/**
	...
	var createRefractor$5 = (Type) => (value, options = {}) => refract$6(value, {
		...options,
		Type
	});
	//#endregion
	//#region ../apidom-core/src/refractor/registration.mjs
	import_minim.ObjectElement.refract = createRefractor$5(import_minim.ObjectElement);
	import_minim.ArrayElement.refract = createRefractor$5(import_minim.ArrayElement);
	import_minim.StringElement.refract = createRefractor$5(import_minim.StringElement);
	import_minim.BooleanElement.refract = createRefractor$5(import_minim.BooleanElement);
	import_minim.NullElement.refract = createRefractor$5(import_minim.NullElement);
	import_minim.NumberElement.refract = createRefractor$5(import_minim.NumberElement);
	import_minim.LinkElement.refract = createRefractor$5(import_minim.LinkElement);
	import_minim.RefElement.refract = createRefractor$5(import_minim.RefElement);
	...
	* @public
	*/
	var JSONSchema202012MediaTypes = class extends MediaTypes {
	...
	* @public
	*/
	var mediaTypes = new JSONSchema202012MediaTypes("application/schema;version=2020-12", "application/schema+json;version=2020-12", "application/schema+yaml;version=2020-12");
	//#endregion
	...
	* @public
	*/
	var JSONSchemaVisitor$4 = class extends Mixin(FixedFieldsVisitor, ParentSchemaAwareVisitor, FallbackVisitor) {
		constructor(options) {
			super(options);
	...
	* @public
	*/
	var ItemsVisitor$2 = class extends Mixin(SpecificationVisitor, ParentSchemaAwareVisitor, FallbackVisitor) {
		ObjectElement(objectElement) {
	...
	* @public
	*/
	var RequiredVisitor = class extends FallbackVisitor {
		ArrayElement(arrayElement) {
	...
	* @public
	*/
	var PropertiesVisitor$1 = class extends Mixin(MapVisitor, ParentSchemaAwareVisitor, FallbackVisitor) {
		constructor(options) {
			super(options);
	...
	* @public
	*/
	var PatternPropertiesVisitor$1 = class extends Mixin(MapVisitor, ParentSchemaAwareVisitor, FallbackVisitor) {
		constructor(options) {
			super(options);
			this.element = new import_minim.ObjectElement();
	...
	* @public
	*/
	var DependenciesVisitor = class extends Mixin(MapVisitor, ParentSchemaAwareVisitor, FallbackVisitor) {
		constructor(options) {
			super(options);
			this.element = new import_minim.ObjectElement();
	...
	* @public
	*/
	var EnumVisitor = class extends FallbackVisitor {
		ArrayElement(arrayElement) {
			const result = this.enter(arrayElement);
	...
	* @public
	*/
	var TypeVisitor = class extends FallbackVisitor {
	...
	* @public
	*/
	var AllOfVisitor$1 = class extends Mixin(SpecificationVisitor, ParentSchemaAwareVisitor, FallbackVisitor) {
		constructor(options) {
			super(options);
			this.element = new import_minim.ArrayElement();
	...
	* @public
	*/
	var AnyOfVisitor$1 = class extends Mixin(SpecificationVisitor, ParentSchemaAwareVisitor, FallbackVisitor) {
		constructor(options) {
			super(options);
			this.element = new import_minim.ArrayElement();
	...
	* @public
	*/
	var OneOfVisitor$1 = class extends Mixin(SpecificationVisitor, ParentSchemaAwareVisitor, FallbackVisitor) {
		constructor(options) {
			super(options);
			this.element = new import_minim.ArrayElement();
	...
	* @public
	*/
	var DefinitionsVisitor = class extends Mixin(MapVisitor, ParentSchemaAwareVisitor, FallbackVisitor) {
		constructor(options) {
			super(options);
			this.element = new import_minim.ObjectElement();
	...
	* @public
	*/
	var LinksVisitor = class extends Mixin(SpecificationVisitor, ParentSchemaAwareVisitor, FallbackVisitor) {
		constructor(options) {
			super(options);
			this.element = new import_minim.ArrayElement();
	...
	* @public
	*/
	var JSONReferenceVisitor = class extends Mixin(FixedFieldsVisitor, FallbackVisitor) {
		constructor(options) {
			super(options);
	...
	* @public
	*/
	var MediaVisitor = class extends Mixin(FixedFieldsVisitor, FallbackVisitor) {
		constructor(options) {
			super(options);
	...
	* @public
	*/
	var LinkDescriptionVisitor$4 = class extends Mixin(FixedFieldsVisitor, FallbackVisitor) {
		constructor(options) {
			super(options);
	...
	*/
	...
	JSONSchema$4.refract = createRefractor$4([
		"visitors",
		"document",
		"objects",
		"JSONSchema",
	...
	LinkDescription$4.refract = createRefractor$4([
		"visitors",
		"document",
		"objects",
		"LinkDescription",
	...
	* @public
	*/
	var ExamplesVisitor = class extends FallbackVisitor {
		ArrayElement(arrayElement) {
			const result = this.enter(arrayElement);
	...
	* @public
	*/
	var $vocabularyVisitor = class extends FallbackVisitor {
		ObjectElement(objectElement) {
	...
	* @public
	*/
	var $defsVisitor = class extends Mixin(MapVisitor, ParentSchemaAwareVisitor, FallbackVisitor) {
		constructor(options) {
			super(options);
			this.element = new import_minim.ObjectElement();
	...
	* @public
	*/
	var AllOfVisitor = class extends Mixin(SpecificationVisitor, ParentSchemaAwareVisitor, FallbackVisitor) {
		constructor(options) {
			super(options);
			this.element = new import_minim.ArrayElement();
			this.element.classes.push("json-schema-allOf");
	...
	* @public
	*/
	var AnyOfVisitor = class extends Mixin(SpecificationVisitor, ParentSchemaAwareVisitor, FallbackVisitor) {
		constructor(options) {
			super(options);
			this.element = new import_minim.ArrayElement();
			this.element.classes.push("json-schema-anyOf");
	...
	* @public
	*/
	var OneOfVisitor = class extends Mixin(SpecificationVisitor, ParentSchemaAwareVisitor, FallbackVisitor) {
		constructor(options) {
			super(options);
			this.element = new import_minim.ArrayElement();
			this.element.classes.push("json-schema-oneOf");
	...
	* @public
	*/
	var DependentSchemasVisitor = class extends Mixin(MapVisitor, ParentSchemaAwareVisitor, FallbackVisitor) {
		constructor(options) {
			super(options);
			this.element = new import_minim.ObjectElement();
	...
	* @public
	*/
	var ItemsVisitor = class extends Mixin(SpecificationVisitor, ParentSchemaAwareVisitor, FallbackVisitor) {
		ObjectElement(objectElement) {
			this.element = this.toRefractedElement([
				"document",
				"objects",
	...
	* @public
	*/
	var PropertiesVisitor = class extends Mixin(MapVisitor, ParentSchemaAwareVisitor, FallbackVisitor) {
		constructor(options) {
			super(options);
			this.element = new import_minim.ObjectElement();
			this.element.classes.push("json-schema-properties");
	...
	* @public
	*/
	var PatternPropertiesVisitor = class extends Mixin(MapVisitor, ParentSchemaAwareVisitor, FallbackVisitor) {
		constructor(options) {
			super(options);
			this.element = new import_minim.ObjectElement();
			this.element.classes.push("json-schema-patternProperties");
	...
	* @public
	*/
	var DependentRequiredVisitor = class extends FallbackVisitor {
		ObjectElement(objectElement) {
			const result = super.enter(objectElement);
	...
	*/
	...
	//#endregion
	//#region src/elements/JSONSchema.ts
	/**
	* @public
	*/
	...
	//#endregion
	//#region src/elements/LinkDescription.ts
	/**
	* URI: https://json-schema.org/draft/2019-09/draft-handrews-json-schema-hyperschema-02#rfc.section.6
	* @public
	*/
	...
	*/
	...
	var schema = {
		...
		"json-schema-patternProperties": { "[key: *]": function key(...args) {
			return new JSONSchema(...args);
		} },
		...
		"json-schema-links": { "<*>": function asterisk(...args) {
	...
	*/
	...
	//#endregion
	//#region src/refractor/visitors/json-schema/index.ts
	/**
	* @public
	*/
	...
	//#endregion
	//#region src/refractor/visitors/json-schema/PrefixItemsVisitor.ts
	/**
	* @public
	*/
	var PrefixItemsVisitor = class extends Mixin(SpecificationVisitor, ParentSchemaAwareVisitor, FallbackVisitor) {
		constructor(options) {
			super(options);
			this.element = new import_minim.ArrayElement();
	...
	//#endregion
	//#region src/refractor/visitors/json-schema/link-description/index.ts
	/**
	* @public
	*/
	...
	var specification = pipe(assocPath([
		"visitors",
		"document",
		"objects",
		"JSONSchema",
		"$visitor"
	], JSONSchemaVisitor), dissocPath([
		"visitors",
		"document",
		"objects",
		"JSONSchema",
		...
		"fixedFields",
		"$dynamicAnchor"
	], specification$1.visitors.value), dissocPath([
		"visitors",
		"document",
		"objects",
		"JSONSchema",
		...
		"fixedFields",
		"$dynamicRef"
	], specification$1.visitors.value), assocPath([
		"visitors",
		"document",
		"objects",
		"JSONSchema",
		...
		"fixedFields",
		"submissionSchema"
	], JSONSchemaVisitor))(specification$1);
	//#endregion
	...
	*/
	var refract = (value, { specPath = [
		...
		"JSONSchema",
		"$visitor"
	], plugins = [], specificationObj = specification } = {}) => {
		const element = (0, import_minim.refract)(value);
		const resolvedSpec = dereference(specificationObj);
		const rootVisitor = new (path(specPath, resolvedSpec))({ specObj: resolvedSpec });
		visit$1(element, rootVisitor);
