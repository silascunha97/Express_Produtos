(function(global, factory) {
	typeof exports === "object" && typeof module !== "undefined" ? factory(exports) : typeof define === "function" && define.amd ? define(["exports"], factory) : (global = typeof globalThis !== "undefined" ? globalThis : global || self, factory(global.apidomParserAdapterAsyncapiJson2 = {}));
	...
	* @public
	*/
	var isNode$3 = (node) => typeof getNodeType$5(node) === "string";
	/**
	* @public
	*/
	...
	*  @public
	*/
	var visit$2 = (root, visitor, { keyMap = null, state = {}, breakSymbol = BREAK, deleteNodeSymbol = null, skipVisitingNodeSymbol = false, visitFnGetter = getVisitFn, nodeTypeGetter = getNodeType$5, nodePredicate = isNode$3, nodeCloneFn = cloneNode$1, detectCycles = true, detectCyclesCallback = null } = {}) => {
	...
	*/
	visit$2[Symbol.for("nodejs.util.promisify.custom")] = async (root, visitor, { keyMap = null, state = {}, breakSymbol = BREAK, deleteNodeSymbol = null, skipVisitingNodeSymbol = false, visitFnGetter = getVisitFn, nodeTypeGetter = getNodeType$5, nodePredicate = isNode$3, nodeCloneFn = cloneNode$1, detectCycles = true, detectCyclesCallback = null } = {}) => {
		const visitorKeys = keyMap || {};
		let stack;
		let inArray = Array.isArray(root);
		let keys = [root];
	...
	*/
	...
	var isNode$2 = pipe(getNodeType$4, isString$1);
	/**
	* @public
	*/
	var keyMapDefault$1 = {
 ...
 /** @suppress {checkTypes} */ entry.value = addFunction(value, value.sig);
	...
	*/
	...
	var getNodeType$3 = (node) => {
		if (isParseResultElement(node)) return "ParseResultElement";
		if (isElement(node)) return getNodeType$4(node);
	...
	* @public
	*/
	var AsyncApiVersion = class extends import_minim.StringElement {
		constructor(content, meta, attributes) {
			super(content, meta, attributes);
	...
	* @public
	*/
	var ChannelBindings = class extends import_minim.ObjectElement {
		constructor(content, meta, attributes) {
			super(content, meta, attributes);
	...
	* @public
	*/
	var Channels = class extends import_minim.ObjectElement {
		constructor(content, meta, attributes) {
			super(content, meta, attributes);
	...
	* @public
	*/
	var Components = class extends import_minim.ObjectElement {
		constructor(content, meta, attributes) {
			super(content, meta, attributes);
	...
	* @public
	*/
	var Contact = class extends import_minim.ObjectElement {
		constructor(content, meta, attributes) {
			super(content, meta, attributes);
	...
	* @public
	*/
	var CorrelationID = class extends import_minim.ObjectElement {
		constructor(content, meta, attributes) {
			super(content, meta, attributes);
	...
	* @public
	*/
	var DefaultContentType = class extends import_minim.StringElement {
		constructor(content, meta, attributes) {
			super(content, meta, attributes);
	...
	* @public
	*/
	var ExternalDocumentation = class extends import_minim.ObjectElement {
		constructor(content, meta, attributes) {
			super(content, meta, attributes);
	...
	* @public
	*/
	var Identifier = class extends import_minim.StringElement {
		constructor(content, meta, attributes) {
			super(content, meta, attributes);
	...
	* @public
	*/
	var License = class extends import_minim.ObjectElement {
		constructor(content, meta, attributes) {
			super(content, meta, attributes);
	...
	* @public
	*/
	var Message = class extends import_minim.ObjectElement {
		constructor(content, meta, attributes) {
			super(content, meta, attributes);
	...
	* @public
	*/
	var MessageBindings = class extends import_minim.ObjectElement {
		constructor(content, meta, attributes) {
			super(content, meta, attributes);
	...
	* @public
	*/
	var MessageExample = class extends import_minim.ObjectElement {
		constructor(content, meta, attributes) {
			super(content, meta, attributes);
	...
	* @public
	*/
	var MessageTrait = class extends import_minim.ObjectElement {
		constructor(content, meta, attributes) {
			super(content, meta, attributes);
	...
	* @public
	*/
	var OAuthFlow = class extends import_minim.ObjectElement {
		constructor(content, meta, attributes) {
			super(content, meta, attributes);
	...
	* @public
	*/
	var OperationBindings = class extends import_minim.ObjectElement {
		constructor(content, meta, attributes) {
			super(content, meta, attributes);
	...
	* @public
	*/
	var OperationTrait = class extends import_minim.ObjectElement {
		constructor(content, meta, attributes) {
			super(content, meta, attributes);
	...
	* @public
	*/
	var Parameters = class extends import_minim.ObjectElement {
		constructor(content, meta, attributes) {
			super(content, meta, attributes);
	...
	* @public
	*/
	var Reference = class extends import_minim.ObjectElement {
		constructor(content, meta, attributes) {
			super(content, meta, attributes);
	...
	* @public
	*/
	var Server = class extends import_minim.ObjectElement {
		constructor(content, meta, attributes) {
			super(content, meta, attributes);
			this.element = "server";
		}
	...
	* @public
	*/
	var ServerBindings = class extends import_minim.ObjectElement {
		constructor(content, meta, attributes) {
			super(content, meta, attributes);
	...
	* @public
	*/
	var Servers = class extends import_minim.ObjectElement {
		constructor(content, meta, attributes) {
			super(content, meta, attributes);
	...
	* @public
	*/
	var ServerVariable = class extends import_minim.ObjectElement {
		constructor(content, meta, attributes) {
			super(content, meta, attributes);
	...
	* @public
	*/
	var Tag = class extends import_minim.ObjectElement {
		constructor(content, meta, attributes) {
			super(content, meta, attributes);
			this.element = "tag";
		}
	...
	* @public
	*/
	var Tags = class extends import_minim.ArrayElement {
		constructor(content, meta, attributes) {
			super(content, meta, attributes);
			this.element = "tags";
		}
	...
	* @public
	*/
	var AmqpChannelBinding = class extends import_minim.ObjectElement {
		constructor(content, meta, attributes) {
			super(content, meta, attributes);
	...
	* @public
	*/
	var AmqpMessageBinding = class extends import_minim.ObjectElement {
		constructor(content, meta, attributes) {
			super(content, meta, attributes);
	...
	* @public
	*/
	var AmqpOperationBinding = class extends import_minim.ObjectElement {
		constructor(content, meta, attributes) {
			super(content, meta, attributes);
	...
	* @public
	*/
	var AmqpServerBinding = class extends import_minim.ObjectElement {
		constructor(content, meta, attributes) {
			super(content, meta, attributes);
	...
	* @public
	*/
	var Amqp1ChannelBinding = class extends import_minim.ObjectElement {
		constructor(content, meta, attributes) {
			super(content, meta, attributes);
	...
	* @public
	*/
	var Amqp1MessageBinding = class extends import_minim.ObjectElement {
		constructor(content, meta, attributes) {
			super(content, meta, attributes);
	...
	* @public
	*/
	var Amqp1OperationBinding = class extends import_minim.ObjectElement {
		constructor(content, meta, attributes) {
			super(content, meta, attributes);
	...
	* @public
	*/
	var Amqp1ServerBinding = class extends import_minim.ObjectElement {
		constructor(content, meta, attributes) {
			super(content, meta, attributes);
	...
	* @public
	*/
	var AnypointmqChannelBinding = class extends import_minim.ObjectElement {
		constructor(content, meta, attributes) {
			super(content, meta, attributes);
	...
	* @public
	*/
	var AnypointmqMessageBinding = class extends import_minim.ObjectElement {
		constructor(content, meta, attributes) {
			super(content, meta, attributes);
	...
	* @public
	*/
	var AnypointmqOperationBinding = class extends import_minim.ObjectElement {
		constructor(content, meta, attributes) {
			super(content, meta, attributes);
	...
	* @public
	*/
	var AnypointmqServerBinding = class extends import_minim.ObjectElement {
		constructor(content, meta, attributes) {
			super(content, meta, attributes);
	...
	* @public
	*/
	var GooglepubsubChannelBinding = class extends import_minim.ObjectElement {
		constructor(content, meta, attributes) {
			super(content, meta, attributes);
	...
	* @public
	*/
	var GooglepubsubMessageBinding = class extends import_minim.ObjectElement {
		constructor(content, meta, attributes) {
			super(content, meta, attributes);
	...
	* @public
	*/
	var GooglepubsubOperationBinding = class extends import_minim.ObjectElement {
		constructor(content, meta, attributes) {
			super(content, meta, attributes);
	...
	* @public
	*/
	var GooglepubsubServerBinding = class extends import_minim.ObjectElement {
		constructor(content, meta, attributes) {
			super(content, meta, attributes);
	...
	* @public
	*/
	var HttpChannelBinding = class extends import_minim.ObjectElement {
		constructor(content, meta, attributes) {
			super(content, meta, attributes);
	...
	* @public
	*/
	var HttpMessageBinding = class extends import_minim.ObjectElement {
		constructor(content, meta, attributes) {
			super(content, meta, attributes);
	...
	* @public
	*/
	var HttpOperationBinding = class extends import_minim.ObjectElement {
		constructor(content, meta, attributes) {
			super(content, meta, attributes);
	...
	* @public
	*/
	var HttpServerBinding = class extends import_minim.ObjectElement {
		constructor(content, meta, attributes) {
			super(content, meta, attributes);
	...
	* @public
	*/
	var IbmmqChannelBinding = class extends import_minim.ObjectElement {
		constructor(content, meta, attributes) {
			super(content, meta, attributes);
	...
	* @public
	*/
	var IbmmqMessageBinding = class extends import_minim.ObjectElement {
		constructor(content, meta, attributes) {
			super(content, meta, attributes);
	...
	* @public
	*/
	var IbmmqOperationBinding = class extends import_minim.ObjectElement {
		constructor(content, meta, attributes) {
			super(content, meta, attributes);
	...
	* @public
	*/
	var IbmmqServerBinding = class extends import_minim.ObjectElement {
		constructor(content, meta, attributes) {
			super(content, meta, attributes);
	...
	* @public
	*/
	var JmsChannelBinding = class extends import_minim.ObjectElement {
		constructor(content, meta, attributes) {
			super(content, meta, attributes);
	...
	* @public
	*/
	var JmsMessageBinding = class extends import_minim.ObjectElement {
		constructor(content, meta, attributes) {
			super(content, meta, attributes);
	...
	* @public
	*/
	var JmsOperationBinding = class extends import_minim.ObjectElement {
		constructor(content, meta, attributes) {
			super(content, meta, attributes);
	...
	* @public
	*/
	var JmsServerBinding = class extends import_minim.ObjectElement {
		constructor(content, meta, attributes) {
			super(content, meta, attributes);
	...
	* @public
	*/
	var KafkaChannelBinding = class extends import_minim.ObjectElement {
		constructor(content, meta, attributes) {
			super(content, meta, attributes);
	...
	* @public
	*/
	var KafkaMessageBinding = class extends import_minim.ObjectElement {
		constructor(content, meta, attributes) {
			super(content, meta, attributes);
	...
	* @public
	*/
	var KafkaOperationBinding = class extends import_minim.ObjectElement {
		constructor(content, meta, attributes) {
			super(content, meta, attributes);
	...
	* @public
	*/
	var KafkaServerBinding = class extends import_minim.ObjectElement {
		constructor(content, meta, attributes) {
			super(content, meta, attributes);
	...
	* @public
	*/
	var MercureChannelBinding = class extends import_minim.ObjectElement {
		constructor(content, meta, attributes) {
			super(content, meta, attributes);
	...
	* @public
	*/
	var MercureMessageBinding = class extends import_minim.ObjectElement {
		constructor(content, meta, attributes) {
			super(content, meta, attributes);
	...
	* @public
	*/
	var MercureOperationBinding = class extends import_minim.ObjectElement {
		constructor(content, meta, attributes) {
			super(content, meta, attributes);
	...
	* @public
	*/
	var MercureServerBinding = class extends import_minim.ObjectElement {
		constructor(content, meta, attributes) {
			super(content, meta, attributes);
	...
	* @public
	*/
	var MqttChannelBinding = class extends import_minim.ObjectElement {
		constructor(content, meta, attributes) {
			super(content, meta, attributes);
	...
	* @public
	*/
	var MqttMessageBinding = class extends import_minim.ObjectElement {
		constructor(content, meta, attributes) {
			super(content, meta, attributes);
	...
	* @public
	*/
	var MqttOperationBinding = class extends import_minim.ObjectElement {
		constructor(content, meta, attributes) {
			super(content, meta, attributes);
	...
	* @public
	*/
	var MqttServerBinding = class extends import_minim.ObjectElement {
		constructor(content, meta, attributes) {
			super(content, meta, attributes);
	...
	* @public
	*/
	var Mqtt5ChannelBinding = class extends import_minim.ObjectElement {
		constructor(content, meta, attributes) {
			super(content, meta, attributes);
	...
	* @public
	*/
	var Mqtt5MessageBinding = class extends import_minim.ObjectElement {
		constructor(content, meta, attributes) {
			super(content, meta, attributes);
	...
	* @public
	*/
	var Mqtt5OperationBinding = class extends import_minim.ObjectElement {
		constructor(content, meta, attributes) {
			super(content, meta, attributes);
	...
	* @public
	*/
	var Mqtt5ServerBinding = class extends import_minim.ObjectElement {
		constructor(content, meta, attributes) {
			super(content, meta, attributes);
	...
	* @public
	*/
	var NatsChannelBinding = class extends import_minim.ObjectElement {
		constructor(content, meta, attributes) {
			super(content, meta, attributes);
	...
	* @public
	*/
	var NatsMessageBinding = class extends import_minim.ObjectElement {
		constructor(content, meta, attributes) {
			super(content, meta, attributes);
	...
	* @public
	*/
	var NatsOperationBinding = class extends import_minim.ObjectElement {
		constructor(content, meta, attributes) {
			super(content, meta, attributes);
	...
	* @public
	*/
	var NatsServerBinding = class extends import_minim.ObjectElement {
		constructor(content, meta, attributes) {
			super(content, meta, attributes);
	...
	* @public
	*/
	var PulsarChannelBinding = class extends import_minim.ObjectElement {
		constructor(content, meta, attributes) {
			super(content, meta, attributes);
	...
	* @public
	*/
	var PulsarMessageBinding = class extends import_minim.ObjectElement {
		constructor(content, meta, attributes) {
			super(content, meta, attributes);
	...
	* @public
	*/
	var PulsarOperationBinding = class extends import_minim.ObjectElement {
		constructor(content, meta, attributes) {
			super(content, meta, attributes);
	...
	* @public
	*/
	var PulsarServerBinding = class extends import_minim.ObjectElement {
		constructor(content, meta, attributes) {
			super(content, meta, attributes);
	...
	* @public
	*/
	var RedisChannelBinding = class extends import_minim.ObjectElement {
		constructor(content, meta, attributes) {
			super(content, meta, attributes);
	...
	* @public
	*/
	var RedisMessageBinding = class extends import_minim.ObjectElement {
		constructor(content, meta, attributes) {
			super(content, meta, attributes);
	...
	* @public
	*/
	var RedisOperationBinding = class extends import_minim.ObjectElement {
		constructor(content, meta, attributes) {
			super(content, meta, attributes);
	...
	* @public
	*/
	var RedisServerBinding = class extends import_minim.ObjectElement {
		constructor(content, meta, attributes) {
			super(content, meta, attributes);
	...
	* @public
	*/
	var SnsChannelBinding = class extends import_minim.ObjectElement {
		constructor(content, meta, attributes) {
			super(content, meta, attributes);
	...
	* @public
	*/
	var SnsMessageBinding = class extends import_minim.ObjectElement {
		constructor(content, meta, attributes) {
			super(content, meta, attributes);
	...
	* @public
	*/
	var SnsOperationBinding = class extends import_minim.ObjectElement {
		constructor(content, meta, attributes) {
			super(content, meta, attributes);
	...
	* @public
	*/
	var SnsServerBinding = class extends import_minim.ObjectElement {
		constructor(content, meta, attributes) {
			super(content, meta, attributes);
	...
	* @public
	*/
	var SolaceChannelBinding = class extends import_minim.ObjectElement {
		constructor(content, meta, attributes) {
			super(content, meta, attributes);
	...
	* @public
	*/
	var SolaceMessageBinding = class extends import_minim.ObjectElement {
		constructor(content, meta, attributes) {
			super(content, meta, attributes);
	...
	* @public
	*/
	var SolaceOperationBinding = class extends import_minim.ObjectElement {
		constructor(content, meta, attributes) {
			super(content, meta, attributes);
	...
	* @public
	*/
	var SolaceServerBinding = class extends import_minim.ObjectElement {
		constructor(content, meta, attributes) {
			super(content, meta, attributes);
	...
	* @public
	*/
	var SqsChannelBinding = class extends import_minim.ObjectElement {
		constructor(content, meta, attributes) {
			super(content, meta, attributes);
	...
	* @public
	*/
	var SqsMessageBinding = class extends import_minim.ObjectElement {
		constructor(content, meta, attributes) {
			super(content, meta, attributes);
	...
	* @public
	*/
	var SqsOperationBinding = class extends import_minim.ObjectElement {
		constructor(content, meta, attributes) {
			super(content, meta, attributes);
	...
	* @public
	*/
	var SqsServerBinding = class extends import_minim.ObjectElement {
		constructor(content, meta, attributes) {
			super(content, meta, attributes);
	...
	* @public
	*/
	var StompChannelBinding = class extends import_minim.ObjectElement {
		constructor(content, meta, attributes) {
			super(content, meta, attributes);
	...
	* @public
	*/
	var StompMessageBinding = class extends import_minim.ObjectElement {
		constructor(content, meta, attributes) {
			super(content, meta, attributes);
	...
	* @public
	*/
	var StompOperationBinding = class extends import_minim.ObjectElement {
		constructor(content, meta, attributes) {
			super(content, meta, attributes);
	...
	* @public
	*/
	var StompServerBinding = class extends import_minim.ObjectElement {
		constructor(content, meta, attributes) {
			super(content, meta, attributes);
	...
	* @public
	*/
	var WebSocketChannelBinding = class extends import_minim.ObjectElement {
		constructor(content, meta, attributes) {
			super(content, meta, attributes);
	...
	* @public
	*/
	var WebSocketMessageBinding = class extends import_minim.ObjectElement {
		constructor(content, meta, attributes) {
			super(content, meta, attributes);
	...
	* @public
	*/
	var WebSocketOperationBinding = class extends import_minim.ObjectElement {
		constructor(content, meta, attributes) {
			super(content, meta, attributes);
	...
	* @public
	*/
	var WebSocketServerBinding = class extends import_minim.ObjectElement {
		constructor(content, meta, attributes) {
			super(content, meta, attributes);
	...
	*/
	var BindingsVisitor$5 = class extends Mixin(AlternatingVisitor, FallbackVisitor) {
		...
		ObjectElement(objectElement) {
			...
			if (isReferenceElement(this.element)) this.element.setMetaProperty("referenced-element", "serverBindings");
			return result;
		}
	};
	//#endregion
	...
	*/
	var SchemaOrReferenceVisitor = class extends JSONSchemaOrJSONReferenceVisitor {
		enter(element) {
			...
			if (isReferenceElement(this.element)) this.element.setMetaProperty("referenced-element", "schema");
			return result;
		}
	};
	//#endregion
	...
	*/
	var BindingsVisitor$4 = class extends Mixin(AlternatingVisitor, FallbackVisitor) {
		...
		ObjectElement(objectElement) {
			const result = AlternatingVisitor.prototype.enter.call(this, objectElement);
			if (isReferenceElement(this.element)) this.element.setMetaProperty("referenced-element", "operationBindings");
			return result;
		}
	};
	//#endregion
	...
	* @public
	*/
	var OperationTraits = class OperationTraits extends import_minim.ArrayElement {
	...
	*/
	var BindingsVisitor$3 = class extends Mixin(AlternatingVisitor, FallbackVisitor) {
		...
		ObjectElement(objectElement) {
			const result = AlternatingVisitor.prototype.enter.call(this, objectElement);
			if (isReferenceElement(this.element)) this.element.setMetaProperty("referenced-element", "channelBindings");
			return result;
		}
	};
	//#endregion
	...
	*/
	var CorrelationIdVisitor$1 = class extends Mixin(AlternatingVisitor, FallbackVisitor) {
		...
		ObjectElement(objectElement) {
			const result = AlternatingVisitor.prototype.enter.call(this, objectElement);
			if (isReferenceElement(this.element)) this.element.setMetaProperty("referenced-element", "correlationID");
			return result;
		}
	};
	//#endregion
	...
	*/
	var BindingsVisitor$2 = class extends Mixin(AlternatingVisitor, FallbackVisitor) {
		...
		ObjectElement(objectElement) {
			const result = AlternatingVisitor.prototype.enter.call(this, objectElement);
			if (isReferenceElement(this.element)) this.element.setMetaProperty("referenced-element", "messageBindings");
			return result;
		}
	};
	//#endregion
	...
	*/
	var MessageVisitor = class extends Mixin(FixedFieldsVisitor, FallbackVisitor) {
		...
		ObjectElement(objectElement) {
			...
			} else if (mediaTypes.includes(schemaFormat) && isObjectElement(this.element.payload)) this.element.payload = this.toRefractedElement([
				"document",
				"objects",
				"Schema"
			], payload);
	...
	* @public
	*/
	var MessageExamples = class MessageExamples extends import_minim.ArrayElement {
	...
	* @public
	*/
	var MessageTraits = class MessageTraits extends import_minim.ArrayElement {
	...
	* @public
	*/
	var OperationTraitSecurity = class OperationTraitSecurity extends import_minim.ArrayElement {
	...
	* @public
	*/
	var jsonMediaTypes = new AsyncAPIMediaTypes(...mediaTypes.filterByFormat("generic"), ...mediaTypes.filterByFormat("json"));
	//#endregion
	//#region src/adapter.ts
	/**
	* @public
	*/
	var detectionRegExp = /"asyncapi"\s*:\s*"(?<version_json>2\.(?:[1-9]\d*|0)\.(?:[1-9]\d*|0))"/;
	/**
	* @public
	*/
	...
	* @public
	*/
	var namespace = createNamespace(asyncApi2);
	//#endregion
