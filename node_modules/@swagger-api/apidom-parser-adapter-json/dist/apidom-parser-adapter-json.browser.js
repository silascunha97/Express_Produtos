(function(global, factory) {
	typeof exports === "object" && typeof module !== "undefined" ? factory(exports) : typeof define === "function" && define.amd ? define(["exports"], factory) : (global = typeof globalThis !== "undefined" ? globalThis : global || self, factory(global.apidomParserAdapterJson = {}));
	...
	*/
	...
	//#endregion
	//#region src/lexical-analysis/browser-patch.ts
 ...
 /** @suppress {checkTypes} */ entry.value = addFunction(value, value.sig);
	...
	*/
	...
	//#endregion
	//#region wasm/tree-sitter-json.wasm
	...
	//#endregion
	//#region src/lexical-analysis/browser.ts
	var parser = null;
	...
	* @public
	*/
	var ParseResult$1 = class extends Node {
	...
	*  @public
	*/
	var visit$1 = (root, visitor, { keyMap = null, state = {}, breakSymbol = BREAK, deleteNodeSymbol = null, skipVisitingNodeSymbol = false, visitFnGetter = getVisitFn, nodeTypeGetter = getNodeType$3, nodePredicate = isNode$3, nodeCloneFn = cloneNode$1, detectCycles = true, detectCyclesCallback = null } = {}) => {
	...
	*/
	visit$1[Symbol.for("nodejs.util.promisify.custom")] = async (root, visitor, { keyMap = null, state = {}, breakSymbol = BREAK, deleteNodeSymbol = null, skipVisitingNodeSymbol = false, visitFnGetter = getVisitFn, nodeTypeGetter = getNodeType$3, nodePredicate = isNode$3, nodeCloneFn = cloneNode$1, detectCycles = true, detectCyclesCallback = null } = {}) => {
		const visitorKeys = keyMap || {};
		let stack;
		let inArray = Array.isArray(root);
		let keys = [root];
	...
	*/
	...
	var isNode$2 = pipe(getNodeType$2, isString$1);
	/**
	* @public
	*/
	var keyMapDefault = {
	...
	*/
	...
	var refract$1 = (value, { Type, plugins = [] }) => {
		/**
	...
	var createRefractor = (Type) => (value, options = {}) => refract$1(value, {
		...options,
		Type
	});
	//#endregion
	...
	//#endregion
	//#region src/syntactic-analysis/TreeCursorSyntaxNode.ts
	...
	//#endregion
	//#region src/syntactic-analysis/direct/visitors/CstVisitor.ts
	...
	//#endregion
	//#region src/syntactic-analysis/TreeCursorIterator.ts
	...
	//#endregion
	//#region src/syntactic-analysis/direct/index.ts
	var keyMap$2 = {
		document: ["children"],
		object: ["children"],
		array: ["children"],
	...
	*/
	...
	//#endregion
	//#region src/syntactic-analysis/indirect/visitors/CstVisitor.ts
	var keyMap$1 = {
		document: ["children"],
		object: ["children"],
		array: ["children"],
	...
	var CstVisitor = class {
		...
		ERROR(node, key, parent, path) {
			...
			if (path.length === 0) return new ParseResult$1({ children: [errorNode] });
			return errorNode;
		}
	};
	//#endregion
	//#region src/syntactic-analysis/indirect/visitors/JsonAstVisitor.ts
	var keyMap = {
	...
	//#endregion
	//#region src/syntactic-analysis/indirect/index.ts
	/**
	...
	*/
	var analyze$2 = (cst, { sourceMap = false } = {}) => {
		...
		return visit$1(visit$1(rootNode, cstVisitor, {
			keyMap: keyMap$1,
			state: { sourceMap }
		}).rootNode, astVisitor, {
			keyMap,
	...
	* @public
	*/
	var JSONMediaTypes = class extends MediaTypes {
		latest() {
			return this[0];
		}
	};
	...
	* @public
	*/
	var mediaTypes = new JSONMediaTypes("application/json");
	//#endregion
	...
	* @public
	*/
	var detectionRegExp = /(?<true>^\s*true\s*$)|(?<false>^\s*false\s*$)|(?<null>^\s*null\s*$)|(?<number>^\s*\d+\s*$)|(?<object>^\s*{\s*)|(?<array>^\s*\[\s*)|(?<string>^\s*"(((?=\\)\\(["\\/bfnrt]|u[0-9a-fA-F]{4}))|[^"\\\x00-\x1F\x7F])*"\s*$)/;
	//#endregion
	//#region src/adapter-browser.ts
	/**
	* @public
	*/
	var detect = async (source) => {
		if (!detectionRegExp.test(source)) return false;
		let cst = null;
		try {
			cst = await analyze(source);
	...
	* @public
	*/
	var parse = async (source, { sourceMap = false, syntacticAnalysis = "direct" } = {}) => {
		let cst = null;
		try {
			cst = await analyze(source);
			if (syntacticAnalysis === "indirect") return analyze$2(cst, { sourceMap });
