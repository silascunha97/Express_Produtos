(function(global, factory) {
	typeof exports === "object" && typeof module !== "undefined" ? factory(exports) : typeof define === "function" && define.amd ? define(["exports"], factory) : (global = typeof globalThis !== "undefined" ? globalThis : global || self, factory(global.apidomParserAdapterAsyncapiYaml2 = {}));
	...
	*/
	...
	var GenericMapping = class extends Tag$1 {
	...
	var GenericSequence = class extends Tag$1 {
	...
	var GenericString = class extends Tag$1 {
	...
	*/
	...
	var Boolean$1 = class extends Tag$1 {
	...
	var FloatingPoint = class extends Tag$1 {
	...
	var Integer = class extends Tag$1 {
	...
	*/
	...
	var isNode$2 = pipe(getNodeType$3, isString);
	/**
	* @public
	*/
	var keyMapDefault$1 = {
 ...
 /** @suppress {checkTypes} */ entry.value = addFunction(value, value.sig);
	...
	* @public
	*/
	var yamlMediaTypes = new AsyncAPIMediaTypes(...mediaTypes.filterByFormat("generic"), ...mediaTypes.filterByFormat("yaml"));
	//#endregion
	//#region src/adapter.ts
	/**
	* @public
	*/
	var detectionRegExp = /(?<YAML>^(["']?)asyncapi\2\s*:\s*(["']?)(?<version_yaml>2\.(?:[1-9]\d*|0)\.(?:[1-9]\d*|0))\3(?:\s+|$))|(?<JSON>"asyncapi"\s*:\s*"(?<version_json>2\.(?:[1-9]\d*|0)\.(?:[1-9]\d*|0))")/m;
	/**
	* @public
	*/
