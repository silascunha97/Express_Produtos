(function(global, factory) {
	typeof exports === "object" && typeof module !== "undefined" ? factory(exports) : typeof define === "function" && define.amd ? define(["exports"], factory) : (global = typeof globalThis !== "undefined" ? globalThis : global || self, factory(global.apidomNsJsonSchemaDraft6 = {}));
	...
	* @public
	*/
	var JSONSchemaDraft6MediaTypes = class extends MediaTypes {
	...
	* @public
	*/
	var mediaTypes = new JSONSchemaDraft6MediaTypes("application/schema;version=draft-06", "application/schema+json;version=draft-06", "application/schema+yaml;version=draft-06");
	//#endregion
	//#region ../apidom-ns-json-schema-draft-4/src/elements/JSONSchema.mjs
	/**
	* @public
	*/
	var JSONSchema$1 = class extends import_minim.ObjectElement {
		constructor(content, meta, attributes) {
			super(content, meta, attributes);
	...
	* @public
	*/
	var LinkDescription$1 = class extends import_minim.ObjectElement {
		constructor(content, meta, attributes) {
			super(content, meta, attributes);
	...
	* @public
	*/
	var JSONSchemaVisitor$1 = class extends Mixin(FixedFieldsVisitor, ParentSchemaAwareVisitor, FallbackVisitor) {
		constructor(options) {
			super(options);
	...
	* @public
	*/
	var LinkDescriptionVisitor$1 = class extends Mixin(FixedFieldsVisitor, FallbackVisitor) {
		constructor(options) {
			super(options);
	...
	*/
	...
	//#endregion
	//#region src/refractor/visitors/json-schema/ExamplesVisitor.ts
	/**
	* @public
	*/
