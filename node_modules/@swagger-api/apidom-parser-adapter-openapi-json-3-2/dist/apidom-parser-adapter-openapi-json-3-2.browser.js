(function(global, factory) {
	typeof exports === "object" && typeof module !== "undefined" ? factory(exports) : typeof define === "function" && define.amd ? define(["exports"], factory) : (global = typeof globalThis !== "undefined" ? globalThis : global || self, factory(global.apidomParserAdapterOpenapiJson32 = {}));
	...
	* @public
	*/
	var getNodeType$7 = (node) => node === null || node === void 0 ? void 0 : node.type;
	/**
	* @public
	*/
	var isNode$3 = (node) => typeof getNodeType$7(node) === "string";
	/**
	* @public
	*/
	...
	* @public
	*/
	var mergeAll = (visitors, { visitFnGetter = getVisitFn, nodeTypeGetter = getNodeType$7, breakSymbol = BREAK, deleteNodeSymbol = null, skipVisitingNodeSymbol = false, exposeEdits = false } = {}) => {
	...
	var mergeAllAsync = (visitors, { visitFnGetter = getVisitFn, nodeTypeGetter = getNodeType$7, breakSymbol = BREAK, deleteNodeSymbol = null, skipVisitingNodeSymbol = false, exposeEdits = false } = {}) => {
		const skipSymbol = Symbol("skip");
		const skipping = new Array(visitors.length).fill(skipSymbol);
		return {
	...
	*  @public
	*/
	var visit$2 = (root, visitor, { keyMap = null, state = {}, breakSymbol = BREAK, deleteNodeSymbol = null, skipVisitingNodeSymbol = false, visitFnGetter = getVisitFn, nodeTypeGetter = getNodeType$7, nodePredicate = isNode$3, nodeCloneFn = cloneNode$1, detectCycles = true, detectCyclesCallback = null } = {}) => {
	...
	*/
	visit$2[Symbol.for("nodejs.util.promisify.custom")] = async (root, visitor, { keyMap = null, state = {}, breakSymbol = BREAK, deleteNodeSymbol = null, skipVisitingNodeSymbol = false, visitFnGetter = getVisitFn, nodeTypeGetter = getNodeType$7, nodePredicate = isNode$3, nodeCloneFn = cloneNode$1, detectCycles = true, detectCyclesCallback = null } = {}) => {
		const visitorKeys = keyMap || {};
		let stack;
		let inArray = Array.isArray(root);
		let keys = [root];
	...
	*/
	...
	var isNode$2 = pipe(getNodeType$6, isString$1);
	/**
	* @public
	*/
	var keyMapDefault$1 = {
	...
	*/
	...
	var refract$9 = (value, { Type, plugins = [] }) => {
		/**
		...
		*/
		return dispatchPluginsSync(element, plugins, {
			toolboxCreator: createToolbox$8,
			visitorOptions: { nodeTypeGetter: getNodeType$6 }
		});
	};
	var createRefractor$8 = (Type) => (value, options = {}) => refract$9(value, {
		...options,
		Type
	});
	//#endregion
	//#region ../apidom-core/src/refractor/registration.mjs
	import_minim.ObjectElement.refract = createRefractor$8(import_minim.ObjectElement);
	import_minim.ArrayElement.refract = createRefractor$8(import_minim.ArrayElement);
	import_minim.StringElement.refract = createRefractor$8(import_minim.StringElement);
	import_minim.BooleanElement.refract = createRefractor$8(import_minim.BooleanElement);
	import_minim.NullElement.refract = createRefractor$8(import_minim.NullElement);
	import_minim.NumberElement.refract = createRefractor$8(import_minim.NumberElement);
	import_minim.LinkElement.refract = createRefractor$8(import_minim.LinkElement);
	import_minim.RefElement.refract = createRefractor$8(import_minim.RefElement);
	Annotation.refract = createRefractor$8(Annotation);
	Comment.refract = createRefractor$8(Comment);
	ParseResult$1.refract = createRefractor$8(ParseResult$1);
	//#endregion
 ...
 /** @suppress {checkTypes} */ entry.value = addFunction(value, value.sig);
	...
	*/
	var analyze$2 = async (source) => {
		if (parser$4 === null && parserInitLock === null) {
		...
		} else if (parser$4 === null && parserInitLock !== null) parser$4 = await parserInitLock;
		else if (parser$4 === null) throw new ApiDOMError("Error while initializing web-tree-sitter and loading tree-sitter-json grammar.");
		if (activeTrees.size >= MAX_ACTIVE_TREES) {
			const treesToEvict = [...activeTrees];
			activeTrees.clear();
			for (const oldTree of treesToEvict) oldTree.delete();
		}
		const tree = parser$4.parse(source);
	...
	var getNodeType$5 = (node) => {
		if (isParseResultElement(node)) return "ParseResultElement";
		if (isElement(node)) return getNodeType$6(node);
		return getNodeType$7(node);
	};
	...
	*/
	...
	//#endregion
	//#region ../apidom-ns-openapi-3-2/src/media-types.mjs
	/**
	* @public
	*/
	/**
	...
	* @public
	*/
	var createRefractor$7 = (specPath) => (value, options = {}) => refract$7(value, {
		specPath,
		...options
	});
	//#endregion
	...
	*/
	...
	//#endregion
	//#region ../../node_modules/@swaggerexpert/json-pointer/es/parse/index.mjs
	var grammar$4 = new grammar$5();
	//#endregion
	//#region ../../node_modules/@swaggerexpert/json-pointer/es/test/reference-token.mjs
	var grammar$3 = new grammar$5();
	var parser$3 = new Parser();
	//#endregion
	//#region ../../node_modules/@swaggerexpert/json-pointer/es/test/array-location.mjs
	var grammar$2 = new grammar$5();
	var parser$2 = new Parser();
	//#endregion
	//#region ../../node_modules/@swaggerexpert/json-pointer/es/test/array-index.mjs
	var grammar$1 = new grammar$5();
	var parser$1 = new Parser();
	//#endregion
	//#region ../../node_modules/@swaggerexpert/json-pointer/es/test/array-dash.mjs
	var grammar = new grammar$5();
	...
	*/
	...
	//#endregion
	//#region ../apidom-ns-openapi-3-2/src/elements/Callback.mjs
	/**
	* @public
	*/
	var Callback = class extends Callback$1 {};
	//#endregion
	//#region ../apidom-ns-openapi-3-2/src/elements/Components.mjs
	/**
	* @public
	*/
	...
	//#endregion
	//#region ../apidom-ns-openapi-3-2/src/elements/Contact.mjs
	/**
	* @public
	*/
	var Contact = class extends Contact$1 {};
	//#endregion
	//#region ../apidom-ns-openapi-3-2/src/elements/Discriminator.mjs
	/**
	* @public
	*/
	...
	//#endregion
	//#region ../apidom-ns-openapi-3-2/src/elements/Encoding.mjs
	/**
	* @public
	*/
	...
	//#endregion
	//#region ../apidom-ns-openapi-3-2/src/elements/Example.mjs
	/**
	* @public
	*/
	...
	//#endregion
	//#region ../apidom-ns-openapi-3-2/src/elements/ExternalDocumentation.mjs
	/**
	* @public
	*/
	var ExternalDocumentation = class extends ExternalDocumentation$1 {};
	//#endregion
	//#region ../apidom-ns-openapi-3-2/src/elements/Header.mjs
	/**
	* @public
	*/
	...
	//#endregion
	//#region ../apidom-ns-openapi-3-2/src/elements/Info.mjs
	/**
	* @public
	*/
	var Info = class extends Info$1 {};
	//#endregion
	//#region ../apidom-ns-openapi-3-2/src/elements/JsonSchemaDialect.mjs
	/**
	* @public
	*/
	...
	//#endregion
	//#region ../apidom-ns-openapi-3-2/src/elements/License.mjs
	/**
	* @public
	*/
	var License = class extends License$1 {};
	//#endregion
	//#region ../apidom-ns-openapi-3-2/src/elements/Link.mjs
	/**
	* @public
	*/
	var Link = class extends Link$1 {};
	//#endregion
	//#region ../apidom-ns-openapi-3-2/src/elements/MediaType.mjs
	/**
	* @public
	*/
	...
	//#endregion
	//#region ../apidom-ns-openapi-3-2/src/elements/OAuthFlow.mjs
	/**
	* @public
	*/
	...
	//#endregion
	//#region ../apidom-ns-openapi-3-2/src/elements/OAuthFlows.mjs
	/**
	* @public
	*/
	...
	//#endregion
	//#region ../apidom-ns-openapi-3-2/src/elements/Openapi.mjs
	/**
	* @public
	*/
	var Openapi = class extends Openapi$1 {};
	//#endregion
	//#region ../apidom-ns-openapi-3-2/src/elements/OpenApi3-2.mjs
	/**
	* @public
	*/
	...
	//#endregion
	//#region ../apidom-ns-openapi-3-2/src/elements/Operation.mjs
	/**
	* @public
	*/
	var Operation = class extends Operation$1 {};
	//#endregion
	//#region ../apidom-ns-openapi-3-2/src/elements/Parameter.mjs
	/**
	* @public
	*/
	...
	//#endregion
	//#region ../apidom-ns-openapi-3-2/src/elements/PathItem.mjs
	/**
	* @public
	*/
	...
	//#endregion
	//#region ../apidom-ns-openapi-3-2/src/elements/Paths.mjs
	/**
	* @public
	*/
	var Paths = class extends Paths$1 {};
	//#endregion
	//#region ../apidom-ns-openapi-3-2/src/elements/Reference.mjs
	/**
	* @public
	*/
	...
	//#endregion
	//#region ../apidom-ns-openapi-3-2/src/elements/RequestBody.mjs
	/**
	* @public
	*/
	var RequestBody = class extends RequestBody$1 {};
	//#endregion
	//#region ../apidom-ns-openapi-3-2/src/elements/Response.mjs
	/**
	* @public
	*/
	...
	//#endregion
	//#region ../apidom-ns-openapi-3-2/src/elements/Responses.mjs
	/**
	* @public
	*/
	var Responses = class extends Responses$1 {};
	//#endregion
	//#region ../apidom-ns-openapi-3-2/src/elements/Schema.mjs
	/**
	* @public
	*/
	var Schema = class extends Schema$1 {};
	//#endregion
	//#region ../apidom-ns-openapi-3-2/src/elements/SecurityRequirement.mjs
	/**
	* @public
	*/
	var SecurityRequirement = class extends SecurityRequirement$1 {};
	//#endregion
	//#region ../apidom-ns-openapi-3-2/src/elements/SecurityScheme.mjs
	/**
	* @public
	*/
	...
	//#endregion
	//#region ../apidom-ns-openapi-3-2/src/elements/Server.mjs
	/**
	* @public
	*/
	...
	//#endregion
	//#region ../apidom-ns-openapi-3-2/src/elements/ServerVariable.mjs
	/**
	* @public
	*/
	var ServerVariable = class extends ServerVariable$1 {};
	//#endregion
	//#region ../apidom-ns-openapi-3-2/src/elements/Tag.mjs
	/**
	* @public
	*/
	...
	//#endregion
	//#region ../apidom-ns-openapi-3-2/src/elements/Xml.mjs
	/**
	* @public
	*/
	...
	//#endregion
	//#region ../apidom-ns-openapi-3-2/src/namespace.mjs
	/**
	* @public
	*/
	...
	//#endregion
	//#region ../apidom-ns-openapi-3-2/src/elements/nces/ComponentsPathItems.mjs
	/**
	* @public
	*/
	var ComponentsPathItems = class extends ComponentsPathItems$1 {};
	//#endregion
	//#region ../apidom-ns-openapi-3-2/src/elements/nces/ComponentsMediaTypes.mjs
	/**
	* @public
	*/
	...
	//#endregion
	//#region ../apidom-ns-openapi-3-2/src/elements/nces/Webhooks.mjs
	/**
	* @public
	*/
	var Webhooks = class extends Webhooks$1 {};
	//#endregion
	//#region ../apidom-ns-openapi-3-2/src/traversal/visitor.mjs
	/**
	* @public
	*/
	...
	*/
	...
	//#endregion
	//#region ../apidom-ns-openapi-3-2/src/predicates.mjs
	...
	*/
	...
	//#endregion
	//#region ../apidom-ns-openapi-3-2/src/refractor/toolbox.mjs
	/**
	* @public
	*/
	/**
	...
	*/
	...
	//#endregion
	//#region ../apidom-ns-openapi-3-2/src/refractor/visitors/open-api-3-2/index.mjs
	/**
	* @public
	*/
	/**
	...
	*/
	...
	//#endregion
	//#region ../apidom-ns-openapi-3-2/src/refractor/visitors/open-api-3-2/info/index.mjs
	/**
	* @public
	*/
	...
	*/
	...
	//#endregion
	//#region ../apidom-ns-openapi-3-2/src/refractor/visitors/open-api-3-2/contact/index.mjs
	/**
	* @public
	*/
	...
	*/
	...
	//#endregion
	//#region ../apidom-ns-openapi-3-2/src/refractor/visitors/open-api-3-2/license/index.mjs
	/**
	* @public
	*/
	...
	*/
	...
	//#endregion
	//#region ../apidom-ns-openapi-3-2/src/refractor/visitors/open-api-3-2/link/index.mjs
	/**
	* @public
	*/
	...
	*/
	...
	//#endregion
	//#region ../apidom-ns-openapi-3-2/src/refractor/visitors/open-api-3-2/JsonSchemaDialectVisitor.mjs
	/**
	* @public
	*/
	/**
	...
	*/
	...
	//#endregion
	//#region ../apidom-ns-openapi-3-2/src/refractor/visitors/open-api-3-2/server/index.mjs
	/**
	* @public
	*/
	...
	*/
	...
	//#endregion
	//#region ../apidom-ns-openapi-3-2/src/refractor/visitors/open-api-3-2/server-variable/index.mjs
	/**
	* @public
	*/
	...
	*/
	...
	//#endregion
	//#region ../apidom-ns-openapi-3-2/src/refractor/visitors/open-api-3-2/media-type/index.mjs
	/**
	* @public
	*/
	...
	*/
	...
	//#endregion
	//#region ../apidom-ns-openapi-3-2/src/refractor/visitors/open-api-3-2/security-requirement/index.mjs
	/**
	* @public
	*/
	...
	*/
	...
	//#endregion
	//#region ../apidom-ns-openapi-3-2/src/refractor/visitors/open-api-3-2/components/index.mjs
	/**
	* @public
	*/
	...
	*/
	...
	//#endregion
	//#region ../apidom-ns-openapi-3-2/src/refractor/visitors/open-api-3-2/tag/index.mjs
	/**
	* @public
	*/
	...
	*/
	...
	//#endregion
	//#region ../apidom-ns-openapi-3-2/src/refractor/visitors/open-api-3-2/reference/index.mjs
	/**
	* @public
	*/
	...
	*/
	...
	//#endregion
	//#region ../apidom-ns-openapi-3-2/src/refractor/visitors/open-api-3-2/parameter/index.mjs
	/**
	* @public
	*/
	...
	*/
	...
	//#endregion
	//#region ../apidom-ns-openapi-3-2/src/refractor/visitors/open-api-3-2/header/index.mjs
	/**
	* @public
	*/
	...
	*/
	...
	//#endregion
	//#region ../apidom-ns-openapi-3-2/src/refractor/visitors/open-api-3-2/schema/index.mjs
	/**
	* @public
	*/
	/**
	...
	*/
	...
	//#endregion
	//#region ../apidom-ns-openapi-3-2/src/refractor/visitors/open-api-3-2/schema/$defsVisitor.mjs
	/**
	* @public
	*/
	/**
	...
	*/
	...
	//#endregion
	//#region ../apidom-ns-openapi-3-2/src/refractor/visitors/open-api-3-2/schema/AllOfVisitor.mjs
	/**
	* @public
	*/
	...
	//#endregion
	//#region ../apidom-ns-openapi-3-2/src/refractor/visitors/open-api-3-2/schema/AnyOfVisitor.mjs
	/**
	* @public
	*/
	...
	//#endregion
	//#region ../apidom-ns-openapi-3-2/src/refractor/visitors/open-api-3-2/schema/OneOfVisitor.mjs
	/**
	* @public
	*/
	...
	//#endregion
	//#region ../apidom-ns-openapi-3-2/src/refractor/visitors/open-api-3-2/schema/DependentSchemasVisitor.mjs
	/**
	* @public
	*/
	...
	//#endregion
	//#region ../apidom-ns-openapi-3-2/src/refractor/visitors/open-api-3-2/schema/PrefixItemsVisitor.mjs
	/**
	* @public
	*/
	...
	//#endregion
	//#region ../apidom-ns-openapi-3-2/src/refractor/visitors/open-api-3-2/schema/PropertiesVisitor.mjs
	/**
	* @public
	*/
	...
	//#endregion
	//#region ../apidom-ns-openapi-3-2/src/refractor/visitors/open-api-3-2/schema/PatternPropertiesVisitor.mjs
	/**
	* @public
	*/
	...
	//#endregion
	//#region ../apidom-ns-openapi-3-2/src/refractor/visitors/open-api-3-2/distriminator/index.mjs
	/**
	* @public
	*/
	...
	*/
	...
	//#endregion
	//#region ../apidom-ns-openapi-3-2/src/refractor/visitors/open-api-3-2/xml/index.mjs
	/**
	* @public
	*/
	...
	*/
	...
	//#endregion
	//#region ../apidom-ns-openapi-3-2/src/refractor/visitors/open-api-3-2/components/SchemasVisitor.mjs
	/**
	* @public
	*/
	/**
	...
	*/
	...
	//#endregion
	//#region ../apidom-ns-openapi-3-2/src/refractor/visitors/open-api-3-2/components/PathItemsVisitor.mjs
	/**
	* @public
	*/
	/**
	...
	*/
	...
	//#endregion
	//#region ../apidom-ns-openapi-3-2/src/refractor/visitors/open-api-3-2/components/MediaTypesVisitor.mjs
	/**
	* @public
	*/
	/**
	...
	*/
	...
	//#endregion
	//#region ../apidom-ns-openapi-3-2/src/refractor/visitors/open-api-3-2/path-item/AdditionalOperationsVisitor.mjs
	/**
	* @public
	*/
	/**
	...
	*/
	...
	//#endregion
	//#region ../apidom-ns-openapi-3-2/src/refractor/visitors/open-api-3-2/example/index.mjs
	/**
	* @public
	*/
	...
	*/
	...
	//#endregion
	//#region ../apidom-ns-openapi-3-2/src/refractor/visitors/open-api-3-2/external-documentation/index.mjs
	/**
	* @public
	*/
	...
	*/
	...
	//#endregion
	//#region ../apidom-ns-openapi-3-2/src/refractor/visitors/open-api-3-2/encoding/index.mjs
	/**
	* @public
	*/
	...
	*/
	...
	//#endregion
	//#region ../apidom-ns-openapi-3-2/src/refractor/visitors/open-api-3-2/paths/index.mjs
	/**
	* @public
	*/
	...
	*/
	...
	//#endregion
	//#region ../apidom-ns-openapi-3-2/src/refractor/visitors/open-api-3-2/request-body/index.mjs
	/**
	* @public
	*/
	...
	*/
	...
	//#endregion
	//#region ../apidom-ns-openapi-3-2/src/refractor/visitors/open-api-3-2/request-body/ContentVisitor.mjs
	/**
	* @public
	*/
	/**
	...
	*/
	...
	//#endregion
	//#region ../apidom-ns-openapi-3-2/src/refractor/visitors/open-api-3-2/callback/index.mjs
	/**
	* @public
	*/
	...
	*/
	...
	//#endregion
	//#region ../apidom-ns-openapi-3-2/src/refractor/visitors/open-api-3-2/response/index.mjs
	/**
	* @public
	*/
	...
	*/
	...
	//#endregion
	//#region ../apidom-ns-openapi-3-2/src/refractor/visitors/open-api-3-2/response/ContentVisitor.mjs
	/**
	* @public
	*/
	/**
	...
	*/
	...
	//#endregion
	//#region ../apidom-ns-openapi-3-2/src/refractor/visitors/open-api-3-2/responses/index.mjs
	/**
	* @public
	*/
	...
	*/
	...
	//#endregion
	//#region ../apidom-ns-openapi-3-2/src/refractor/visitors/open-api-3-2/operation/index.mjs
	/**
	* @public
	*/
	...
	*/
	...
	//#endregion
	//#region ../apidom-ns-openapi-3-2/src/refractor/visitors/open-api-3-2/path-item/index.mjs
	/**
	* @public
	*/
	...
	*/
	...
	//#endregion
	//#region ../apidom-ns-openapi-3-2/src/refractor/visitors/open-api-3-2/security-scheme/index.mjs
	/**
	* @public
	*/
	...
	*/
	...
	//#endregion
	//#region ../apidom-ns-openapi-3-2/src/refractor/visitors/open-api-3-2/oauth-flows/index.mjs
	/**
	* @public
	*/
	...
	*/
	...
	//#endregion
	//#region ../apidom-ns-openapi-3-2/src/refractor/visitors/open-api-3-2/oauth-flow/index.mjs
	/**
	* @public
	*/
	...
	*/
	...
	//#endregion
	//#region ../apidom-ns-openapi-3-2/src/refractor/visitors/open-api-3-2/WebhooksVisitor.mjs
	/**
	* @public
	*/
	/**
	...
	*/
	...
	//#endregion
	//#region ../apidom-ns-openapi-3-2/src/refractor/specification.mjs
	...
	*/
	...
	//#endregion
	//#region ../apidom-ns-openapi-3-2/src/refractor/index.mjs
	...
	//#endregion
	//#region ../apidom-ns-openapi-3-2/src/refractor/registration.mjs
	...
	* @public
	*/
	var jsonMediaTypes = new OpenAPIMediaTypes(...mediaTypes.filterByFormat("generic"), ...mediaTypes.filterByFormat("json"));
	//#endregion
	//#region src/adapter.ts
	/**
	* @public
	*/
	var detectionRegExp = /"openapi"\s*:\s*"(?<version_json>3\.2\.(?:[1-9]\d*|0))"/;
	/**
	* @public
	*/
	var detect = async (source) => detectionRegExp.test(source) && await detect$1(source);
	/**
	* @public
	*/
	...
	* @public
	*/
	var namespace = createNamespace(openApi3_2);
	//#endregion
