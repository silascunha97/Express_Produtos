...
class OpenAPI3_1DereferenceVisitor {
  ...
  OpenApi3_1Element = {
    leave: (openApi3_1Element, key, parent, path, ancestors, link) => {
      ...
      if (!((_this$options$derefer1 = this.options.dereference.strategyOpts['openapi-3-1']) != null && _this$options$derefer1.dereferenceDiscriminatorMapping)) {
        return undefined;
      }
  ...
  async ReferenceElement(referencingElement, key, parent, path, ancestors, link) {
    ...
    if (ancestorsLineage.includes(referencedElement)) {
      ...
      if (this.options.dereference.circular === 'replace') {
        ...
        const replacer = (_this$options$derefer10 = (_this$options$derefer11 = this.options.dereference.strategyOpts['openapi-3-1']) == null ? void 0 : _this$options$derefer11.circularReplacer) != null ? _this$options$derefer10 : this.options.dereference.circularReplacer;
  ...
  async SchemaElement(referencingElement, key, parent, path, ancestors, link) {
    ...
    if (ancestorsLineage.includes(referencedElement)) {
      ...
      if (this.options.dereference.circular === 'replace') {
        ...
        const replacer = (_this$options$derefer19 = (_this$options$derefer20 = this.options.dereference.strategyOpts['openapi-3-1']) == null ? void 0 : _this$options$derefer20.circularReplacer) != null ? _this$options$derefer19 : this.options.dereference.circularReplacer;
        const replacement = replacer(refElement);
        link.replaceWith(replacement, mutationReplacer);
        return !parent ? replacement : false;
      }
    ...
    if ((0, _apidomNsOpenapi.isSchemaElement)(referencedElement)) {
      ...
      if ((_this$options$derefer23 = this.options.dereference.strategyOpts['openapi-3-1']) != null && _this$options$derefer23.dereferenceDiscriminatorMapping) {
