...
class AsyncAPI3DereferenceVisitor {
  ...
  AsyncApi3Element = {
    leave: (asyncApi3Element, key, parent) => {
  ...
  async ReferenceElement(referencingElement, key, parent, path, ancestors, link) {
    ...
    if (ancestorsLineage.includes(referencedElement)) {
      ...
      if (this.options.dereference.circular === 'replace') {
        ...
        const replacer = (_this$options$derefer0 = (_this$options$derefer1 = this.options.dereference.strategyOpts['asyncapi-3']) === null || _this$options$derefer1 === void 0 ? void 0 : _this$options$derefer1.circularReplacer) !== null && _this$options$derefer0 !== void 0 ? _this$options$derefer0 : this.options.dereference.circularReplacer;
