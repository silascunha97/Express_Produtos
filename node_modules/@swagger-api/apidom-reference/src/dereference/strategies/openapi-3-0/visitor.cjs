  ...
  async ReferenceElement(referencingElement, key, parent, path, ancestors, link) {
    ...
    if (ancestorsLineage.includes(referencedElement)) {
      ...
      if (this.options.dereference.circular === 'replace') {
        ...
        const replacer = (_this$options$derefer0 = (_this$options$derefer1 = this.options.dereference.strategyOpts['openapi-3-0']) == null ? void 0 : _this$options$derefer1.circularReplacer) != null ? _this$options$derefer0 : this.options.dereference.circularReplacer;
  ...
  async PathItemElement(referencingElement, key, parent, path, ancestors, link) {
    ...
    if (ancestorsLineage.includes(referencedElement)) {
      ...
      if (this.options.dereference.circular === 'replace') {
        ...
        const replacer = (_this$options$derefer11 = (_this$options$derefer12 = this.options.dereference.strategyOpts['openapi-3-0']) == null ? void 0 : _this$options$derefer12.circularReplacer) != null ? _this$options$derefer11 : this.options.dereference.circularReplacer;
        const replacement = replacer(refElement);
        link.replaceWith(replacement, mutationReplacer);
