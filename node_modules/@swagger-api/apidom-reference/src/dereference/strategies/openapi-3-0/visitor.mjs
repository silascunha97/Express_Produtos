...
class OpenAPI3_0DereferenceVisitor {
  ...
  OpenApi3_0Element = {
    leave: (openApi3_0Element, key, parent) => {
  ...
  async ReferenceElement(referencingElement, key, parent, path, ancestors, link) {
    ...
    if (ancestorsLineage.includes(referencedElement)) {
      ...
      if (this.options.dereference.circular === 'replace') {
        ...
        const replacer = (_this$options$derefer0 = (_this$options$derefer1 = this.options.dereference.strategyOpts['openapi-3-0']) === null || _this$options$derefer1 === void 0 ? void 0 : _this$options$derefer1.circularReplacer) !== null && _this$options$derefer0 !== void 0 ? _this$options$derefer0 : this.options.dereference.circularReplacer;
  ...
  async PathItemElement(referencingElement, key, parent, path, ancestors, link) {
    ...
    if (ancestorsLineage.includes(referencedElement)) {
      ...
      if (this.options.dereference.circular === 'replace') {
        ...
        const replacer = (_this$options$derefer11 = (_this$options$derefer12 = this.options.dereference.strategyOpts['openapi-3-0']) === null || _this$options$derefer12 === void 0 ? void 0 : _this$options$derefer12.circularReplacer) !== null && _this$options$derefer11 !== void 0 ? _this$options$derefer11 : this.options.dereference.circularReplacer;
        const replacement = replacer(refElement);
        link.replaceWith(replacement, mutationReplacer);
