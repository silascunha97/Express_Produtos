...
class AsyncAPI2DereferenceVisitor {
  ...
  AsyncApi2Element = {
    leave: (asyncApi2Element, key, parent) => {
  ...
  async ReferenceElement(referencingElement, key, parent, path, ancestors, link) {
    ...
    if (ancestorsLineage.includes(referencedElement)) {
      ...
      if (this.options.dereference.circular === 'replace') {
        ...
        const replacer = (_this$options$derefer0 = (_this$options$derefer1 = this.options.dereference.strategyOpts['asyncapi-2']) === null || _this$options$derefer1 === void 0 ? void 0 : _this$options$derefer1.circularReplacer) !== null && _this$options$derefer0 !== void 0 ? _this$options$derefer0 : this.options.dereference.circularReplacer;
  ...
  async ChannelItemElement(referencingElement, key, parent, path, ancestors, link) {
    ...
    if (ancestorsLineage.includes(referencedElement)) {
      ...
      if (this.options.dereference.circular === 'replace') {
        ...
        const replacer = (_this$options$derefer11 = (_this$options$derefer12 = this.options.dereference.strategyOpts['asyncapi-2']) === null || _this$options$derefer12 === void 0 ? void 0 : _this$options$derefer12.circularReplacer) !== null && _this$options$derefer11 !== void 0 ? _this$options$derefer11 : this.options.dereference.circularReplacer;
        const replacement = replacer(refElement);
        link.replaceWith(replacement, mutationReplacer);
