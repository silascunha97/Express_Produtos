...
class OpenAPI2DereferenceVisitor {
  ...
  getNestedVisitorOptions(referencingElement) {
    ...
    return {
      ...
      resolve: {
        ...
        external: (_this$options$derefer7 = this.options.dereference) != null && (_this$options$derefer7 = _this$options$derefer7.dereferenceOpts) != null && _this$options$derefer7.skipNestedExternal && (0, _apidomCore.toValue)(referencingElement.get('$ref')).startsWith('#') ? false : this.options.resolve.external
      },
      dereference: {
        ...this.options.dereference,
        dereferenceOpts: {
          ...((_this$options$derefer8 = this.options.dereference) == null ? void 0 : _this$options$derefer8.dereferenceOpts),
  ...
  SwaggerElement = {
    leave: (swaggerElement, key, parent) => {
      ...
      if (!((_this$options$derefer9 = this.options.dereference.dereferenceOpts) != null && _this$options$derefer9.continueOnError)) {
        return undefined;
      }
  ...
  async ReferenceElement(referencingElement, key, parent, path, ancestors, link) {
    ...
    if (ancestorsLineage.includes(referencedElement)) {
      ...
      if (this.options.dereference.circular === 'replace') {
        ...
        const replacer = (_this$options$derefer0 = (_this$options$derefer1 = this.options.dereference.strategyOpts['openapi-2']) == null ? void 0 : _this$options$derefer1.circularReplacer) != null ? _this$options$derefer0 : this.options.dereference.circularReplacer;
    ...
    } else if ((_this$options$derefer10 = this.options.dereference.dereferenceOpts) != null && _this$options$derefer10.continueOnError) {
  ...
  async PathItemElement(referencingElement, key, parent, path, ancestors, link) {
    ...
    if (ancestorsLineage.includes(referencedElement)) {
      ...
      if (this.options.dereference.circular === 'replace') {
        ...
        const replacer = (_this$options$derefer11 = (_this$options$derefer12 = this.options.dereference.strategyOpts['openapi-2']) == null ? void 0 : _this$options$derefer12.circularReplacer) != null ? _this$options$derefer11 : this.options.dereference.circularReplacer;
        const replacement = replacer(refElement);
        link.replaceWith(replacement, mutationReplacer);
        return !parent ? replacement : false;
      }
    ...
    if ((isExternalReference || isNonEntryDocument || (0, _apidomNsOpenapi.isPathItemElement)(referencedElement) && (0, _apidomCore.isStringElement)(referencedElement.$ref) || shouldDetectCircular) && !ancestorsLineage.includesCycle(referencedElement)) {
      ...
      directAncestors.delete(referencingElement);
      this.popErrorContext(referencingElement);
    } else if ((_this$options$derefer13 = this.options.dereference.dereferenceOpts) != null && _this$options$derefer13.continueOnError) {
      this.pendingPropagations.push({
        referencingElement,
        referencedElement
      });
  ...
  async JSONReferenceElement(referencingElement, key, parent, path, ancestors, link) {
    ...
    if (ancestorsLineage.includes(referencedElement)) {
      ...
      if (this.options.dereference.circular === 'replace') {
        ...
        const replacer = (_this$options$derefer14 = (_this$options$derefer15 = this.options.dereference.strategyOpts['openapi-2']) == null ? void 0 : _this$options$derefer15.circularReplacer) != null ? _this$options$derefer14 : this.options.dereference.circularReplacer;
        const replacement = replacer(refElement);
        link.replaceWith(replacement, mutationReplacer);
        return !parent ? replacement : false;
      }
    ...
    if ((isExternalReference || isNonEntryDocument || (0, _apidomNsOpenapi.isJSONReferenceElement)(referencedElement) || shouldDetectCircular) && !ancestorsLineage.includesCycle(referencedElement)) {
      ...
      directAncestors.delete(referencingElement);
      this.popErrorContext(referencingElement);
    } else if ((_this$options$derefer16 = this.options.dereference.dereferenceOpts) != null && _this$options$derefer16.continueOnError) {
      this.pendingPropagations.push({
        referencingElement,
        referencedElement
      });
