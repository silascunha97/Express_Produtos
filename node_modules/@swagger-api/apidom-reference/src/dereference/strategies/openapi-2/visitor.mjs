...
class OpenAPI2DereferenceVisitor {
  ...
  handleDereferenceError(error, refEl, opts) {
    ...
    if ((_this$options$derefer2 = this.options.dereference.dereferenceOpts) !== null && _this$options$derefer2 !== void 0 && _this$options$derefer2.continueOnError) {
      var _this$options$derefer3, _this$options$derefer4, _this$options$derefer5;
      const {
        directAncestors,
  ...
  getNestedVisitorOptions(referencingElement) {
    ...
    return {
      ...
      resolve: {
        ...
        external: (_this$options$derefer7 = this.options.dereference) !== null && _this$options$derefer7 !== void 0 && (_this$options$derefer7 = _this$options$derefer7.dereferenceOpts) !== null && _this$options$derefer7 !== void 0 && _this$options$derefer7.skipNestedExternal && toValue(referencingElement.get('$ref')).startsWith('#') ? false : this.options.resolve.external
      },
      dereference: {
        ...this.options.dereference,
        dereferenceOpts: {
          ...((_this$options$derefer8 = this.options.dereference) === null || _this$options$derefer8 === void 0 ? void 0 : _this$options$derefer8.dereferenceOpts),
  ...
  SwaggerElement = {
    leave: (swaggerElement, key, parent) => {
      var _this$options$derefer9;
      if (!((_this$options$derefer9 = this.options.dereference.dereferenceOpts) !== null && _this$options$derefer9 !== void 0 && _this$options$derefer9.continueOnError)) {
        return undefined;
      }
  ...
  async ReferenceElement(referencingElement, key, parent, path, ancestors, link) {
    ...
    if (ancestorsLineage.includes(referencedElement)) {
      ...
      if (this.options.dereference.circular === 'replace') {
        ...
        const replacer = (_this$options$derefer0 = (_this$options$derefer1 = this.options.dereference.strategyOpts['openapi-2']) === null || _this$options$derefer1 === void 0 ? void 0 : _this$options$derefer1.circularReplacer) !== null && _this$options$derefer0 !== void 0 ? _this$options$derefer0 : this.options.dereference.circularReplacer;
    ...
    } else if ((_this$options$derefer10 = this.options.dereference.dereferenceOpts) !== null && _this$options$derefer10 !== void 0 && _this$options$derefer10.continueOnError) {
  ...
  async PathItemElement(referencingElement, key, parent, path, ancestors, link) {
    ...
    if (ancestorsLineage.includes(referencedElement)) {
      ...
      if (this.options.dereference.circular === 'replace') {
        var _this$options$derefer11, _this$options$derefer12;
        const refElement = new RefElement(referencedElement.id, {
          type: 'path-item',
          uri: reference.uri,
          $ref: toValue(referencingElement.$ref)
        });
        const replacer = (_this$options$derefer11 = (_this$options$derefer12 = this.options.dereference.strategyOpts['openapi-2']) === null || _this$options$derefer12 === void 0 ? void 0 : _this$options$derefer12.circularReplacer) !== null && _this$options$derefer11 !== void 0 ? _this$options$derefer11 : this.options.dereference.circularReplacer;
        const replacement = replacer(refElement);
        link.replaceWith(replacement, mutationReplacer);
        return !parent ? replacement : false;
      }
    ...
    if ((isExternalReference || isNonEntryDocument || isPathItemElement(referencedElement) && isStringElement(referencedElement.$ref) || shouldDetectCircular) && !ancestorsLineage.includesCycle(referencedElement)) {
      ...
      directAncestors.delete(referencingElement);
      this.popErrorContext(referencingElement);
    } else if ((_this$options$derefer13 = this.options.dereference.dereferenceOpts) !== null && _this$options$derefer13 !== void 0 && _this$options$derefer13.continueOnError) {
      this.pendingPropagations.push({
        referencingElement,
        referencedElement
      });
  ...
  async JSONReferenceElement(referencingElement, key, parent, path, ancestors, link) {
    ...
    if (ancestorsLineage.includes(referencedElement)) {
      ...
      if (this.options.dereference.circular === 'replace') {
        ...
        const replacer = (_this$options$derefer14 = (_this$options$derefer15 = this.options.dereference.strategyOpts['openapi-2']) === null || _this$options$derefer15 === void 0 ? void 0 : _this$options$derefer15.circularReplacer) !== null && _this$options$derefer14 !== void 0 ? _this$options$derefer14 : this.options.dereference.circularReplacer;
        const replacement = replacer(refElement);
        link.replaceWith(replacement, mutationReplacer);
        return !parent ? replacement : false;
      }
    ...
    if ((isExternalReference || isNonEntryDocument || isJSONReferenceElement(referencedElement) || shouldDetectCircular) && !ancestorsLineage.includesCycle(referencedElement)) {
      ...
      directAncestors.delete(referencingElement);
      this.popErrorContext(referencingElement);
    } else if ((_this$options$derefer16 = this.options.dereference.dereferenceOpts) !== null && _this$options$derefer16 !== void 0 && _this$options$derefer16.continueOnError) {
      this.pendingPropagations.push({
        referencingElement,
        referencedElement
      });
