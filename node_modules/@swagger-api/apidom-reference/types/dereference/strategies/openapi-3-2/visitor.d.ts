...
import { ReferenceElement, PathItemElement, LinkElement, ExampleElement, SchemaElement, OpenApi3_2Element } from '@swagger-api/apidom-ns-openapi-3-2';
...
export interface OpenAPI3_2DereferenceVisitorOptions {
    ...
    readonly pendingPropagations?: Array<{
 ...
 * @public
 */
declare class OpenAPI3_2DereferenceVisitor {
    ...
    protected readonly errorPropagationCache: Map<Element, unknown[]>;
    protected readonly pendingPropagations: Array<{
        referencingElement: Element;
        referencedElement: Element;
    }>;
    constructor({ reference, namespace, options, indirections, ancestors, refractCache, allOfDiscriminatorMapping, $selfValue, errorContext, errorPropagationCache, pendingPropagations, }: OpenAPI3_2DereferenceVisitorOptions);
    protected popErrorContext(el: Element): void;
    protected runPropagationPass(): boolean;
    protected propagateErrors(): void;
    protected handleDereferenceError(error: unknown, refEl: Element, opts?: {
        directAncestors?: Set<Element>;
    ...
    readonly OpenApi3_2Element: {
        enter: (openApi3_2Element: OpenApi3_2Element) => undefined;
        leave: (openApi3_2Element: OpenApi3_2Element, key: string | number, parent: Element | undefined, path: (string | number)[], ancestors: [Element | Element[]], link: {
            replaceWith: (element: Element, replacer: typeof mutationReplacer) => void;
        }) => OpenApi3_2Element | undefined;
    };
