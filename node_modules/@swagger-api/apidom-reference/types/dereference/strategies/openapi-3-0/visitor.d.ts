...
import { ReferenceElement, ExampleElement, LinkElement, PathItemElement, OpenApi3_0Element } from '@swagger-api/apidom-ns-openapi-3-0';
...
declare class OpenAPI3_0DereferenceVisitor {
    ...
    constructor({ reference, namespace, options, indirections, ancestors, refractCache, errorContext, errorPropagationCache, pendingPropagations, }: OpenAPI3_0DereferenceVisitorOptions);
    ...
    readonly OpenApi3_0Element: {
        leave: (openApi3_0Element: OpenApi3_0Element, key: string | number, parent: Element | undefined) => OpenApi3_0Element | undefined;
    };
