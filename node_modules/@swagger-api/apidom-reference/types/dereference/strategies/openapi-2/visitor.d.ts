...
import { ReferenceElement, PathItemElement, JSONReferenceElement, SwaggerElement } from '@swagger-api/apidom-ns-openapi-2';
...
declare class OpenAPI2DereferenceVisitor {
    ...
    constructor({ reference, namespace, options, indirections, ancestors, refractCache, errorContext, errorPropagationCache, pendingPropagations, }: OpenAPI2DereferenceVisitorOptions);
    ...
    readonly SwaggerElement: {
        leave: (swaggerElement: SwaggerElement, key: string | number, parent: Element | undefined) => SwaggerElement | undefined;
    };
