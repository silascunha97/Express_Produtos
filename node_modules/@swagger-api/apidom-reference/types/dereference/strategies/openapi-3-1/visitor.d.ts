...
declare class OpenAPI3_1DereferenceVisitor {
    ...
    constructor({ reference, namespace, options, indirections, ancestors, refractCache, allOfDiscriminatorMapping, errorContext, errorPropagationCache, pendingPropagations, }: OpenAPI3_1DereferenceVisitorOptions);
