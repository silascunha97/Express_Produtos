(function(global, factory) {
	typeof exports === "object" && typeof module !== "undefined" ? factory(exports) : typeof define === "function" && define.amd ? define(["exports"], factory) : (global = typeof globalThis !== "undefined" ? globalThis : global || self, factory(global.apidomParserAdapterOpenapiJson30 = {}));
	...
	*/
	...
	var refract$3 = (value, { Type, plugins = [] }) => {
		/**
	...
	var createRefractor$2 = (Type) => (value, options = {}) => refract$3(value, {
		...options,
		Type
	});
	//#endregion
	//#region ../apidom-core/src/refractor/registration.mjs
	import_minim.ObjectElement.refract = createRefractor$2(import_minim.ObjectElement);
	import_minim.ArrayElement.refract = createRefractor$2(import_minim.ArrayElement);
	import_minim.StringElement.refract = createRefractor$2(import_minim.StringElement);
	import_minim.BooleanElement.refract = createRefractor$2(import_minim.BooleanElement);
	import_minim.NullElement.refract = createRefractor$2(import_minim.NullElement);
	import_minim.NumberElement.refract = createRefractor$2(import_minim.NumberElement);
	import_minim.LinkElement.refract = createRefractor$2(import_minim.LinkElement);
	import_minim.RefElement.refract = createRefractor$2(import_minim.RefElement);
	Annotation.refract = createRefractor$2(Annotation);
	Comment.refract = createRefractor$2(Comment);
	ParseResult$1.refract = createRefractor$2(ParseResult$1);
	//#endregion
 ...
 /** @suppress {checkTypes} */ entry.value = addFunction(value, value.sig);
	...
	*/
	...
	//#endregion
	//#region ../apidom-ns-openapi-3-0/src/media-types.mjs
	/**
	* @public
	*/
	/**
	...
	* @public
	*/
	var Callback = class extends import_minim.ObjectElement {
		constructor(content, meta, attributes) {
			super(content, meta, attributes);
	...
	* @public
	*/
	var Discriminator = class extends import_minim.ObjectElement {
		constructor(content, meta, attributes) {
			super(content, meta, attributes);
	...
	* @public
	*/
	var Encoding = class extends import_minim.ObjectElement {
		constructor(content, meta, attributes) {
			super(content, meta, attributes);
	...
	* @public
	*/
	var Example = class extends import_minim.ObjectElement {
		constructor(content, meta, attributes) {
			super(content, meta, attributes);
	...
	* @public
	*/
	var Header = class extends import_minim.ObjectElement {
		constructor(content, meta, attributes) {
			super(content, meta, attributes);
			this.element = "header";
		}
	...
	* @public
	*/
	var Link = class extends import_minim.ObjectElement {
		constructor(content, meta, attributes) {
			super(content, meta, attributes);
			this.element = "link";
		}
	...
	* @public
	*/
	var MediaType = class extends import_minim.ObjectElement {
		constructor(content, meta, attributes) {
			super(content, meta, attributes);
	...
	* @public
	*/
	var Openapi = class extends import_minim.StringElement {
		constructor(content, meta, attributes) {
			super(content, meta, attributes);
	...
	* @public
	*/
	var Paths = class extends import_minim.ObjectElement {
		constructor(content, meta, attributes) {
			super(content, meta, attributes);
			this.element = "paths";
		}
	...
	* @public
	*/
	var RequestBody = class extends import_minim.ObjectElement {
		constructor(content, meta, attributes) {
			super(content, meta, attributes);
	...
	* @public
	*/
	var Response = class extends import_minim.ObjectElement {
		constructor(content, meta, attributes) {
			super(content, meta, attributes);
	...
	* @public
	*/
	var Responses = class extends import_minim.ObjectElement {
		constructor(content, meta, attributes) {
			super(content, meta, attributes);
	...
	* @public
	*/
	var JSONSchema = class extends import_minim.ObjectElement {
		constructor(content, meta, attributes) {
			super(content, meta, attributes);
	...
	* @public
	*/
	var LinkDescription = class extends import_minim.ObjectElement {
		constructor(content, meta, attributes) {
			super(content, meta, attributes);
	...
	* @public
	*/
	var JSONSchemaVisitor = class extends Mixin(FixedFieldsVisitor$1, ParentSchemaAwareVisitor, FallbackVisitor$1) {
		constructor(options) {
			super(options);
	...
	* @public
	*/
	var ItemsVisitor$1 = class extends Mixin(SpecificationVisitor$1, ParentSchemaAwareVisitor, FallbackVisitor$1) {
		ObjectElement(objectElement) {
	...
	* @public
	*/
	var PatternPropertiesVisitor = class extends Mixin(MapVisitor$1, ParentSchemaAwareVisitor, FallbackVisitor$1) {
		constructor(options) {
			super(options);
			this.element = new import_minim.ObjectElement();
	...
	* @public
	*/
	var LinkDescriptionVisitor = class extends Mixin(FixedFieldsVisitor$1, FallbackVisitor$1) {
		constructor(options) {
			super(options);
	...
	* @public
	*/
	var Xml = class extends import_minim.ObjectElement {
		constructor(content, meta, attributes) {
			super(content, meta, attributes);
			this.element = "xml";
		}
	...
	* @public
	*/
	var LinkVisitor = class extends Mixin(FixedFieldsVisitor, FallbackVisitor) {
		constructor(options) {
			super(options);
	...
	* @public
	*/
	var MediaTypeVisitor = class extends Mixin(FixedFieldsVisitor, FallbackVisitor) {
		constructor(options) {
			super(options);
	...
	* @public
	*/
	var ExamplesVisitor$4 = class extends Mixin(MapVisitor, FallbackVisitor) {
		constructor(options) {
			super(options);
			this.element = new import_minim.ObjectElement();
	...
	* @public
	*/
	var ExamplesVisitor$3 = class extends ExamplesVisitor$4 {
		constructor(options) {
			super(options);
	...
	* @public
	*/
	var EncodingVisitor$1 = class extends Mixin(MapVisitor, FallbackVisitor) {
		constructor(options) {
			super(options);
	...
	*/
	var ParameterVisitor = class extends Mixin(FixedFieldsVisitor, FallbackVisitor) {
		...
		ObjectElement(objectElement) {
			const result = FixedFieldsVisitor.prototype.ObjectElement.call(this, objectElement);
			if (isObjectElement(this.element.contentProp)) this.element.contentProp.filter(isMediaTypeElement).forEach((mediaTypeElement, key) => {
	...
	* @public
	*/
	var HeaderVisitor = class extends Mixin(FixedFieldsVisitor, FallbackVisitor) {
		constructor(options) {
			super(options);
	...
	* @public
	*/
	var SchemaVisitor$1 = class extends Mixin(AlternatingVisitor, FallbackVisitor) {
		constructor(options) {
			super(options);
			this.alternator = [{
				predicate: isReferenceLikeElement,
	...
	* @public
	*/
	var ExamplesVisitor$2 = class extends ExamplesVisitor$4 {
		constructor(options) {
			super(options);
	...
	* @public
	*/
	var SchemaVisitor = class extends Mixin(FixedFieldsVisitor, FallbackVisitor) {
		constructor(options) {
			super(options);
	...
	* @public
	*/
	var JSONSchemaTypeVisitor = specification$1.visitors.document.objects.JSONSchema.fixedFields.type;
	/**
	* @public
	*/
	...
	* @public
	*/
	var DiscriminatorVisitor = class extends Mixin(FixedFieldsVisitor, FallbackVisitor) {
		constructor(options) {
			super(options);
	...
	* @public
	*/
	var XmlVisitor = class extends Mixin(FixedFieldsVisitor, FallbackVisitor) {
		constructor(options) {
			super(options);
	...
	* @public
	*/
	var ExamplesVisitor$1 = class extends ExamplesVisitor$4 {
		constructor(options) {
			super(options);
	...
	* @public
	*/
	var ResponsesVisitor$1 = class extends Mixin(MapVisitor, FallbackVisitor) {
		constructor(options) {
			super(options);
	...
	* @public
	*/
	var ExamplesVisitor = class extends Mixin(MapVisitor, FallbackVisitor) {
		constructor(options) {
			super(options);
	...
	* @public
	*/
	var ExampleVisitor = class extends Mixin(FixedFieldsVisitor, FallbackVisitor) {
		constructor(options) {
			super(options);
	...
	* @public
	*/
	var EncodingVisitor = class extends Mixin(FixedFieldsVisitor, FallbackVisitor) {
		constructor(options) {
			super(options);
		...
		ObjectElement(objectElement) {
			const result = FixedFieldsVisitor.prototype.ObjectElement.call(this, objectElement);
			if (isObjectElement(this.element.headers)) this.element.headers.filter(isHeaderElement).forEach((headerElement, key) => {
	...
	* @public
	*/
	var PathsVisitor = class extends Mixin(PatternedFieldsVisitor, FallbackVisitor) {
		constructor(options) {
			super(options);
	...
	* @public
	*/
	var RequestBodyVisitor$1 = class extends Mixin(FixedFieldsVisitor, FallbackVisitor) {
		constructor(options) {
			super(options);
	...
	* @public
	*/
	var CallbackVisitor = class extends Mixin(PatternedFieldsVisitor, FallbackVisitor) {
		constructor(options) {
			super(options);
	...
	* @public
	*/
	var ResponseVisitor = class extends Mixin(FixedFieldsVisitor, FallbackVisitor) {
		constructor(options) {
			super(options);
	...
	* @public
	*/
	var ResponsesVisitor = class extends Mixin(MixedFieldsVisitor, FallbackVisitor) {
		constructor(options) {
			super(options);
	...
	*/
	var DefaultVisitor = class extends Mixin(AlternatingVisitor, FallbackVisitor) {
		...
		ObjectElement(objectElement) {
			const result = AlternatingVisitor.prototype.enter.call(this, objectElement);
			if (isReferenceElement(this.element)) this.element.setMetaProperty("referenced-element", "response");
			else if (isResponseElement(this.element)) this.element.setMetaProperty("http-status-code", "default");
			return result;
		}
	};
	//#endregion
	...
	var ParametersVisitor$2 = class extends Mixin(SpecificationVisitor, FallbackVisitor) {
		...
		ArrayElement(arrayElement) {
			arrayElement.forEach((item) => {
				...
				const element = this.toRefractedElement(specPath, item);
				if (isReferenceElement(element)) element.setMetaProperty("referenced-element", "parameter");
				this.element.push(element);
			});
			this.copyMetaAndAttributes(arrayElement, this.element);
			return BREAK;
	...
	* @public
	*/
	var RequestBodyVisitor = class extends AlternatingVisitor {
		constructor(options) {
			super(options);
			this.alternator = [{
				predicate: isReferenceLikeElement,
		...
		ObjectElement(objectElement) {
			const result = AlternatingVisitor.prototype.enter.call(this, objectElement);
			if (isReferenceElement(this.element)) this.element.setMetaProperty("referenced-element", "requestBody");
			return result;
		}
	};
	//#endregion
	...
	* @public
	*/
	var PathItemVisitor = class extends Mixin(FixedFieldsVisitor, FallbackVisitor) {
		constructor(options) {
			super(options);
	...
	* Note: Specification object allows to use absolute internal JSON pointers.
	*/
	var { fixedFields: jsonSchemaFixedFields } = specification$1.visitors.document.objects.JSONSchema;
	/**
	* @public
	*/
	...
	* @public
	*/
	var detectionRegExp = /"openapi"\s*:\s*"(?<version_json>3\.0\.(?:[1-9]\d*|0))"/;
	/**
	* @public
	*/
	...
	* @public
	*/
	var namespace = createNamespace(openApi3_0);
	//#endregion
