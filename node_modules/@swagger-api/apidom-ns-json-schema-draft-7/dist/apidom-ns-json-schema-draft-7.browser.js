(function(global, factory) {
	typeof exports === "object" && typeof module !== "undefined" ? factory(exports) : typeof define === "function" && define.amd ? define(["exports"], factory) : (global = typeof globalThis !== "undefined" ? globalThis : global || self, factory(global.apidomNsJsonSchemaDraft7 = {}));
	...
	* @public
	*/
	var JSONSchemaDraft7MediaTypes = class extends MediaTypes {
	...
	* @public
	*/
	var mediaTypes = new JSONSchemaDraft7MediaTypes("application/schema;version=draft-07", "application/schema+json;version=draft-07", "application/schema+yaml;version=draft-07");
	//#endregion
	...
	* @public
	*/
	var JSONSchemaVisitor$2 = class extends Mixin(FixedFieldsVisitor, ParentSchemaAwareVisitor, FallbackVisitor) {
		constructor(options) {
			super(options);
	...
	* @public
	*/
	var ItemsVisitor$1 = class extends Mixin(SpecificationVisitor, ParentSchemaAwareVisitor, FallbackVisitor) {
		ObjectElement(objectElement) {
	...
	* @public
	*/
	var LinkDescriptionVisitor$2 = class extends Mixin(FixedFieldsVisitor, FallbackVisitor) {
		constructor(options) {
			super(options);
	...
	* @public
	*/
	var ItemsVisitor = class extends ItemsVisitor$1 {
		BooleanElement(booleanElement) {
	...
	*/
	...
	var schema = {
		...
		"json-schema-dependencies": { "[key: *]": function key(...args) {
			return new JSONSchema(...args);
		} },
		...
		"json-schema-definitions": { "[key: *]": function key(...args) {
			return new JSONSchema(...args);
		} },
	...
	*/
	...
	var specification = pipe(assocPath([
		...
		"fixedFields",
		"if"
	], specification$1.visitors.JSONSchemaOrJSONReferenceVisitor), assocPath([
		"visitors",
		"document",
		"objects",
		"JSONSchema",
		...
		"fixedFields",
		"else"
	], specification$1.visitors.JSONSchemaOrJSONReferenceVisitor), dissocPath([
		"visitors",
		"document",
		"objects",
		"JSONSchema",
		...
		"fixedFields",
		"submissionMediaType"
	], specification$1.visitors.value))(specification$1);
	//#endregion
